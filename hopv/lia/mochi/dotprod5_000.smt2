...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) ) 
    (=>
      (and
        (|bcopy_aux$unknown:10| H B)
        (|make_array$unknown:18| A H B)
        (let ((a!1 (= (= 0 G) (and (not (= 0 E)) (not (= 0 F))))))
  (and (not (= (= 0 F) (<= B C)))
       (not (= (= 0 E) (= D 0)))
       (not (= 0 G))
