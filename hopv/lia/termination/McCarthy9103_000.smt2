...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) ) 
    (=>
      (and
        (|mc91_1030$unknown:12| I H C D)
        (|mc91_without_checking_1058$unknown:16| H G C D)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (|mc91_1030$unknown:7| A B J)
        (|mc91_without_checking_1058$unknown:16| I H D E)
        (|mc91_without_checking_1058$unknown:15| D C F)
        (and (= 0 G) (= E 1) (= H (+ 11 D)) (= (= 0 G) (<= D 100)))
      )
      (|mc91_without_checking_1058$unknown:15| A B J)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (|mc91_1030$unknown:7| B A K)
        (|mc91_without_checking_1058$unknown:16| J I E F)
        (|mc91_without_checking_1058$unknown:16| C B A K)
        (|mc91_without_checking_1058$unknown:15| E D G)
        (and (= 0 H) (= F 1) (= I (+ 11 E)) (= (= 0 H) (<= E 100)))
      )
      (|mc91_1030$unknown:8| C B A K)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) ) 
    (=>
      (and
        ...
        (|mc91_without_checking_1058$unknown:16| G F B C)
        (and (= 0 E) (= C 1) (= F (+ 11 B)) (= (= 0 E) (<= B 100)))
      )
      (|mc91_1030$unknown:11| G B C)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      ...
      (|mc91_without_checking_1058$unknown:15| F B C)
    )
  )
)
(assert
