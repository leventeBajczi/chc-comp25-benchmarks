...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (|fib_1030$unknown:12| J I C D)
        (|fib_without_checking_1060$unknown:16| H G C D)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (|fib_1030$unknown:7| A B K)
        (|fib_without_checking_1060$unknown:16| I H D E)
        (|fib_without_checking_1060$unknown:15| D C F)
        (and (= 0 G) (= E 1) (= J (+ (- 2) D)) (= H (+ (- 1) D)) (= (= 0 G) (<= 2 D)))
      )
      (|fib_without_checking_1060$unknown:15| A B K)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) ) 
    (=>
      (and
        (|fib_1030$unknown:7| B A L)
        (|fib_without_checking_1060$unknown:16| J I E F)
        (|fib_without_checking_1060$unknown:16| C B A L)
        (|fib_without_checking_1060$unknown:15| E D G)
        (and (= 0 H) (= F 1) (= K (+ (- 2) E)) (= I (+ (- 1) E)) (= (= 0 H) (<= 2 E)))
      )
      (|fib_1030$unknown:8| C B A L)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) ) 
    (=>
      (and
        ...
        (|fib_without_checking_1060$unknown:16| G F B C)
        (and (= 0 E) (= C 1) (= H (+ (- 2) B)) (= F (+ (- 1) B)) (= (= 0 E) (<= 2 B)))
      )
      (|fib_1030$unknown:11| H B C)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      ...
      (|fib_without_checking_1060$unknown:15| F B C)
    )
  )
)
(assert
