  ...
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Bool) (S Bool) ) 
    (=>
      (and
        ...
        (let ((a!1 (and (not H) G F E D (= J I) (= L K) (= N M) (= P O)))
      ...
      (a!6 (and (not H)
                ...
                (= N M)
                (= P O))))
  (and (or B C R (not S) (not A) (= Q 0) a!1)
       (or B
           C
           R
           (not S)
       ...
       (or R S (not A) (not C) (not B) (<= 1 J) a!2)
       (or R
           S
           (not A)
           (not C)
       ...
       (or A
           ...
           (and (not H)
                ...
                (= N M)
                (= P O)))
       (or A C R (not S) (not B) a!3)
       (or C
           R
           S
           (not A)
           (not B)
           (and (not H) (not G) F E (not D) (= L K) (= N M) (= N I) (= P O)))
       (or R (not S) (not A) (not C) (not B) a!4)
       (or C R (not S) (not A) (not B) a!5)
       (or B R (not S) (not A) (not C) a!1)
       (or A R (not S) (not C) (not B) a!2)
       (or A
           B
           C
           R
