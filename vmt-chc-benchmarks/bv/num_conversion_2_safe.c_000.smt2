...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D (_ BitVec 8)) (E (_ BitVec 8)) (F (_ BitVec 8)) (G (_ BitVec 8)) (H (_ BitVec 8)) (I (_ BitVec 8)) (J (_ BitVec 8)) (K (_ BitVec 32)) (L (_ BitVec 32)) (M (_ BitVec 8)) (N (_ BitVec 32)) (O (_ BitVec 32)) (P (_ BitVec 32)) (Q (_ BitVec 32)) (R (_ BitVec 8)) (S (_ BitVec 8)) (T (_ BitVec 8)) (U (_ BitVec 8)) (V Bool) (W Bool) (X Bool) ) 
    (=>
      (and
        (state X W V S R L O Q F I D)
        (let ((a!1 (and (not C)
                (not B)
                A
                (not V)
