...
(let ((a!4 (and A
                ...
                (= I H)
                (= (+ R (* (- 1.0) L)) 1.0)))
      (a!5 (and a!3 (= J2 T) (= R 0.0) (= (+ R (* (- 1.0) L)) 1.0)))
      (a!6 (and a!3
                (= J2 V)
                (not (= R 0.0))
                (= R 1.0)
      ...
      (a!11 (and A
                 ...
                 (= I H)
                 (= (+ D1 (* (- 1.0) S1)) 1.0)))
      (a!12 (and a!10 (= N2 T) (= D1 0.0) (= (+ D1 (* (- 1.0) S1)) 1.0)))
      (a!13 (and a!10
                 (= N2 V)
                 (not (= D1 0.0))
                 (= D1 1.0)
...
(let ((a!9 (and A
                ...
                (= I H)
                (= (+ M (* (- 1.0) L)) 1.0)))
      (a!16 (or (and (or a!12 a!13 a!14 a!15) (not (<= T1 N2)) (= P1 0.0))
                (and (or a!12 a!13 a!14 a!15) (<= T1 N2) (= P1 1.0)))))
(let ((a!17 (and A
                 (not B)
                 (not G)
                 (not F)
      ...
      (a!21 (and a!16
                 ...
                 (= J H1)
                 (= (+ S1 (* (- 1.0) T2)) (- 1.0)))))
(let ((a!22 (or (and (or a!18 a!19 a!20 a!21)
                     (= H2 T2)
                     (= H2 0.0)
                     (= Z1 R2)
                     (= F1 T))
                (and (or a!18 a!19 a!20 a!21)
                     (= H2 T2)
                     (not (= H2 0.0))
                     (= H2 1.0)
                     (= Z1 R2)
...
(let ((a!32 (and A
  ...
  (or (and (not A)
      ...
      (and A
           ...
           (= M L)
           (= I H))
      (and A B (not G) F E D C E3 (not F3) G3))))))))))))))
      )
      (state C
       D
       E
