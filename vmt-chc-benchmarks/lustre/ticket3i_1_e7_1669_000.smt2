    ...
    (=>
      ...
      (a!2 (= (or (and (not C)
                  ...
                  (and C
                       ...
                       (not V6)))
              N1))
      (a!3 (= K5 (or Q1 (and G5 (<= 0 J5) (<= 0 I5) (<= 0 H5) (<= 0 F5)))))
      (a!4 (or (not Z3) (= (+ F1 (* (- 1) L4)) (- 1))))
      (a!5 (or (not A4) (= (+ A2 (* (- 1) N4)) (- 1))))
      (a!6 (or (not E4) (= (+ F1 (* (- 1) M4)) (- 1))))
      (a!7 (or (not F4) (= (+ A2 (* (- 1) O4)) (- 1))))
      (a!8 (or (not J4) (= (+ F1 (* (- 1) T3)) (- 1))))
      (a!9 (or (not K4) (= (+ A2 (* (- 1) D3)) (- 1))))
      (a!10 (or K6 (and (not (<= 3 V5)) (not (<= 3 T5)) (not (<= 3 P5)))))
      (a!11 (or Z2 (and (not (<= 3 T1)) (not (<= 3 X1)) (not (<= 3 G2))))))
  (and (= (= X1 2) K4)
       (= (= T1 2) A4)
       a!1
       a!2
