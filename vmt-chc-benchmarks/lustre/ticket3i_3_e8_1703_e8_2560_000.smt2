...
(assert
  ...
  (and (= (or (not G2) (<= 0 I2)) V1)
       ...
       (= E2 D2)
       (= H2 F2)
       (or A3 (not (<= 3 E2)) (not (<= 3 Z1)) (not (<= 3 B2)))
       (or (= W2 P) Y2)
       (or (not Y2) (= W2 Z))
       (or (= X1 E) C2)
       (or (not C2) (= X1 E1))
    ...
    (=>
      ...
      (a!2 (= (or (and (not C)
                  ...
                  (and C
                       ...
                       (not V6)))
              T1))
      (a!3 (or (not A4) (= (+ L1 (* (- 1) M4)) (- 1))))
      (a!4 (or (not B4) (= (+ H2 (* (- 1) O4)) (- 1))))
      (a!5 (or (not F4) (= (+ L1 (* (- 1) N4)) (- 1))))
      (a!6 (or (not G4) (= (+ H2 (* (- 1) P4)) (- 1))))
      (a!7 (or (not K4) (= (+ L1 (* (- 1) I3)) (- 1))))
      (a!8 (or (not L4) (= (+ H2 (* (- 1) E3)) (- 1)))))
  (and (= (= B2 2) G4)
       (= (= Z1 2) B4)
       a!1
       a!2
       ...
       (= H1 B2)
       (= G1 Z1)
       (or M6 (not (<= 3 W5)) (not (<= 3 T5)) (not (<= 3 R5)))
       (or A3 (not (<= 3 Z1)) (not (<= 3 B2)) (not (<= 3 E2)))
       (or V6 (= X1 W1))
       (or (not V6) (= W1 C1))
       (or (not C3) (= B3 D3))
       (or (not C3) (= F3 E3))
