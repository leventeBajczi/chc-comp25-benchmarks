       ...
       I1)
        (let ((a!1 (= W3
              (and J1
                   ...
                   (not (<= 1 R3))
                   (not (<= 32767 V3)))))
      (a!2 (or (not L2) (= (+ X4 (* (- 1) K2)) (- 2))))
      (a!3 (or (not L2) (= (+ K1 (* (- 1) N2)) (- 1))))
      (a!4 (or (not O2) (= (+ M1 (* (- 1) R2)) (- 1))))
      (a!5 (or (not W4) (= (+ Y4 (* (- 1) V4)) (- 2))))
      (a!6 (or (not W4) (= (+ L1 (* (- 1) J2)) (- 1))))
      (a!7 (or (not H2) (not (= (<= 0 M3) O3))))
      (a!8 (or (not G2) (not (= (<= 0 H3) J3))))
      (a!9 (or (not F2) (not (= (<= M3 0) N3))))
      (a!10 (or (not E2) (not (= (<= H3 0) I3)))))
  (and (= (+ B4 H3 (* (- 1) Z3)) 0)
       (= (+ D2 M1 (* (- 1) L1)) 0)
       (= (+ M1 C2 (* (- 1) K1)) 0)
       (= A3 N2)
