    ...
    (=>
      ...
      (a!2 (= (or (and (not C)
                  ...
                  (and C
                       ...
                       (not H6)))
              L))
      (a!3 (= K3 (and (<= 1 S) (<= 1 (+ W V)))))
      (a!4 (or (not G3) (= (+ V (* (- 1) Z3)) (- 1))))
      (a!5 (or (not G3) (= (+ S (* (- 1) F3)) 1)))
      (a!6 (or (not I3) (= (+ W (* (- 1) E4)) (- 2))))
      (a!7 (or (not I3) (= (+ T (* (- 1) U3)) 1)))
      (a!8 (or (not I3) (= (+ S (* (- 1) H3)) 1)))
      (a!9 (or (not K3) (= (+ W V (* (- 1) D4)) (- 1))))
      (a!10 (or (not K3) (= (+ S (* (- 1) J3)) 1)))
      (a!11 (or (not M3) (= (+ W S (* (- 1) L3)) 1)))
      (a!12 (or (not M3) (= (+ T (* (- 1) X3)) (- 1))))
      (a!13 (or (not O3) (= (+ W V T S (* (- 1) N3)) 1)))
      (a!14 (or (not Q3) (= (+ T (* (- 1) B3)) 1)))
      (a!15 (or (not Q3) (= (+ S (* (- 1) P3)) (- 1))))
      (a!16 (or (not S3) (= (+ W (* (- 1) E3)) 1)))
      (a!17 (or (not S3) (= (+ S (* (- 1) R3)) (- 1))))
      (a!18 (or (not T3) (= (+ V (* (- 1) X2)) 1)))
      (a!19 (or (not T3) (= (+ S (* (- 1) W2)) (- 1))))
      (a!20 (or (not W3) (= (+ V (* (- 1) B4)) 1)))
      (a!21 (or (not W3) (= (+ T (* (- 1) V3)) (- 1)))))
  (and (= (<= 1 W) S3)
       (= (<= 1 V) T3)
       (= (<= 1 V) W3)
       (= (<= 1 T) Q3)
       ...
       a!1
       a!2
       (= (or (not S4) (<= U4 1) (<= T4 1)) R4)
       (= (or (not O) (<= P 1) (<= Q 1)) N)
       (= (and (<= 1 S) (= T 0) (= V 0) (= W 0)) G3)
       (= (and (<= 1 S) (<= 1 T)) I3)
       a!3
       (= Q4 (and X P4))
       (= B5 Q4)
