    ...
    (=>
      ...
      (a!5 (= O4
              (= (+ M2
                    ...
                    (* (- 1) J4))
                 0)))
      (a!6 (or Q2 (and U6 (not (<= T6 0)))))
      (a!7 (or (not A5) (= (+ N2 (* (- 1) Z4)) 1)))
      (a!8 (or (not A5) (= (+ F2 (* (- 1) Q5)) (- 1))))
      (a!9 (or (not C5) (= (+ L2 J2 (* (- 1) B6)) 0)))
      (a!10 (or (not C5) (= (+ H2 F2 (* (- 1) V5)) (- 1))))
      (a!11 (or (not C5) (= (+ N2 (* (- 1) B5)) 1)))
      (a!12 (or (not E5) (= (+ N2 (* (- 1) D5)) 1)))
      (a!13 (or (not E5) (= (+ L2 (* (- 1) K6)) (- 1))))
      (a!14 (or (not G5) (= (+ L2 J2 H2 F2 (* (- 1) W5)) 0)))
      (a!15 (or (not G5) (= (+ N2 (* (- 1) F5)) 1)))
      (a!16 (or (not I5) (= (+ N2 (* (- 1) H5)) (- 1))))
      (a!17 (or (not I5) (= (+ L2 (* (- 1) F4)) 1)))
      (a!18 (or (not K5) (= (+ N2 (* (- 1) J5)) (- 1))))
      (a!19 (or (not K5) (= (+ H2 (* (- 1) I4)) 1)))
      (a!20 (or (not M5) (= (+ N2 (* (- 1) L5)) (- 1))))
      (a!21 (or (not M5) (= (+ J2 (* (- 1) R4)) 1)))
      (a!22 (or (not N5) (= (+ N2 (* (- 1) U4)) (- 1))))
      (a!23 (or (not N5) (= (+ F2 (* (- 1) V4)) 1)))
      (a!24 (or (not T5) (= (+ L2 (* (- 1) G6)) (- 1))))
      (a!25 (or (not T5) (= (+ F2 (* (- 1) S5)) 1)))
      (a!26 (or (not Y5) (= (+ L2 (* (- 1) J6)) (- 1))))
      (a!27 (or (not A6) (= (+ J2 H2 (* (- 1) Z5)) 1)))
      (a!28 (or (not D6) (= (+ L2 (* (- 1) I6)) (- 1)))))
  (and (= (<= 1 J2) M5)
       (= (<= 1 H2) K5)
       (= (<= 1 F2) N5)
       (= (<= 1 F2) T5)
