...
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) ) 
    (=>
      ...
      (block_5_function_f__30_31_0 E H C D I F A G B J)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) ) 
    (=>
      ...
      (block_6_f_29_31_0 E H C D I F A G B J)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Bool) (Q Int) (R state_type) (S state_type) (T state_type) (U state_type) (V state_type) (W Int) (X tx_type) (Y Int) (Z Int) ) 
    (=>
      (and
        (block_6_f_29_31_0 E W C D X R A S B Y)
        (let ((a!1 (store (balances T) K (+ (select (balances T) K) L)))
      (a!2 (store (balances S) W (+ (select (balances S) W) (* (- 1) L)))))
  (and (= P (= N O))
       (= U (state_type a!1))
       (= T (state_type a!2))
       (= V (ite (= W K) S U))
       ...
       (= Z Q)
       (= O 700)
       (= N (select (balances V) M))
       (= Q 100)
       (= Y 0)
       (>= (select (balances S) W) 0)
       (>= I 0)
       (>= B 0)
       (>= M 0)
       (>= K 0)
      ...
      (block_8_function_f__30_31_0 F W C D X R A V B Z)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) ) 
    (=>
      (and
        (block_8_function_f__30_31_0 E H C D I F A G B J)
        true
      )
...
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) ) 
    (=>
      (and
        (block_7_return_function_f__30_31_0 E H C D I F A G B J)
        true
      )
      (summary_3_function_f__30_31_0 E H C D I F A G B)
    )
...
(assert
  ...
  (and (= P (= N O))
      ...
      (block_7_return_function_f__30_31_0 F W C D X R A V B Z)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) ) 
    (=>
      ...
      (block_9_function_f__30_31_0 E H C D I F A G B J)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D abi_type) (E crypto_type) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) ) 
    (=>
      (and
        (block_9_function_f__30_31_0 F M D E N I A J B O)
