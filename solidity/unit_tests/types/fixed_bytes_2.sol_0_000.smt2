...
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      ...
      (summary_10_function_g__29_30_0 D G B C H E I F J A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) (M Int) (N Int) (v_14 state_type) (v_15 Int) ) 
    (=>
      (and
        (block_8_f_20_30_0 D I B C J G K M H L N)
        (summary_10_function_g__29_30_0 E I B C J H L v_14 v_15 A)
        (and (= v_14 H)
     (= v_15 L)
     (>= F 0)
     (>= N 0)
     ...
     (= F L))
      ...
      (summary_3_function_f__21_30_0 E I B C J G K M H L N)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (block_11_function_f__21_30_0 C F A B G D H J E I K)
        true
      )
...
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Bool) (I Int) (J state_type) (K state_type) (L Int) (M tx_type) (N Int) (O Int) (P Int) (Q Int) (v_17 state_type) (v_18 Int) ) 
    (=>
      (and
        (block_8_f_20_30_0 D L B C M J N P K O Q)
        (summary_10_function_g__29_30_0 E L B C M K O v_17 v_18 A)
        (and (= v_17 K)
     (= v_18 O)
     (= I O)
     (= E 0)
     ...
     (= H (= I G)))
      ...
      (block_11_function_f__21_30_0 F L B C M J N P K O Q)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J Int) (K Int) (L Bool) (M Int) (N state_type) (O state_type) (P Int) (Q tx_type) (R Int) (S Int) (T Int) (U Int) (v_21 state_type) (v_22 Int) ) 
    (=>
      (and
        (block_8_f_20_30_0 D P B C Q N R T O S U)
        (summary_10_function_g__29_30_0 E P B C Q O S v_21 v_22 A)
        (and (= v_21 O)
     (= v_22 S)
     (= I (= M H))
     (= M S)
