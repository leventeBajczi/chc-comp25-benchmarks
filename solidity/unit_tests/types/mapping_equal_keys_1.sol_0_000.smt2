...
(declare-fun |contract_initializer_entry_11_C_29_0| ( Int Int abi_type crypto_type tx_type state_type state_type |mapping(uint256 => uint256)_tuple| |mapping(uint256 => uint256)_tuple| ) Bool)
(declare-fun |contract_initializer_after_init_12_C_29_0| ( Int Int abi_type crypto_type tx_type state_type state_type |mapping(uint256 => uint256)_tuple| |mapping(uint256 => uint256)_tuple| ) Bool)
(declare-fun |contract_initializer_10_C_29_0| ( Int Int abi_type crypto_type tx_type state_type state_type |mapping(uint256 => uint256)_tuple| |mapping(uint256 => uint256)_tuple| ) Bool)
...
(declare-fun |implicit_constructor_entry_13_C_29_0| ( Int Int abi_type crypto_type tx_type state_type state_type |mapping(uint256 => uint256)_tuple| |mapping(uint256 => uint256)_tuple| ) Bool)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H |mapping(uint256 => uint256)_tuple|) (I Int) (J Int) (K |mapping(uint256 => uint256)_tuple|) (L Int) (M Int) (N Bool) (O |mapping(uint256 => uint256)_tuple|) (P |mapping(uint256 => uint256)_tuple|) (Q state_type) (R state_type) (S Int) (T tx_type) (U Int) (V Int) (W Int) (X Int) ) 
    (=>
      (and
        (block_6_f_27_29_0 C S A B T Q O U W R P V X)
        (and (= G (= E F))
     (= H P)
     (= K P)
     (= M (select (|mapping(uint256 => uint256)_tuple_accessor_array| P) L))
     (= E V)
     (= F X)
     (= I V)
     (= J (select (|mapping(uint256 => uint256)_tuple_accessor_array| P) I))
     (= D 1)
     (= L X)
     (>= M 0)
     (>= E 0)
     ...
     (= N (= J M)))
      ...
      (block_8_function_f__28_29_0 D S A B T Q O U W R P V X)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H |mapping(uint256 => uint256)_tuple|) (I Int) (J Int) (K |mapping(uint256 => uint256)_tuple|) (L Int) (M Int) (N Bool) (O |mapping(uint256 => uint256)_tuple|) (P |mapping(uint256 => uint256)_tuple|) (Q state_type) (R state_type) (S Int) (T tx_type) (U Int) (V Int) (W Int) (X Int) ) 
    (=>
     ...
     (= N (= J M)))
      ...
      (block_7_return_function_f__28_29_0 D S A B T Q O U W R P V X)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F |mapping(uint256 => uint256)_tuple|) (G |mapping(uint256 => uint256)_tuple|) (H |mapping(uint256 => uint256)_tuple|) (I state_type) (J state_type) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) ) 
    (=>
      (and
        (block_9_function_f__28_29_0 C M A B N I F O R J G P S)
