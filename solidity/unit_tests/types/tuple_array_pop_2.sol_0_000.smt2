...
(assert
  (forall ( (A uint_array_tuple) (B uint_array_tuple) (C abi_type) (D crypto_type) (E Int) (F Int) (G uint_array_tuple) (H uint_array_tuple) (I uint_array_tuple) (J uint_array_tuple) (K uint_array_tuple) (L uint_array_tuple) (M state_type) (N state_type) (O Int) (P tx_type) ) 
    (=>
      (and
        (block_6_f_15_17_0 E O C D P M A N B)
        (and (= H G)
     (= K J)
     (= I B)
     (= G L)
     ...
     (= L K))
      ...
      (block_8_function_f__16_17_0 F O C D P M A N B)
    )
  )
)
(assert
...
(assert
  (forall ( (A uint_array_tuple) (B uint_array_tuple) (C uint_array_tuple) (D abi_type) (E crypto_type) (F Int) (G Int) (H uint_array_tuple) (I uint_array_tuple) (J uint_array_tuple) (K uint_array_tuple) (L uint_array_tuple) (M uint_array_tuple) (N uint_array_tuple) (O state_type) (P state_type) (Q Int) (R tx_type) ) 
    (=>
      (and
        (block_6_f_15_17_0 F Q D E R O A P B)
  ...
  (and (= N M)
      ...
      (block_7_return_function_f__16_17_0 G Q D E R O A P C)
    )
  )
)
(assert
