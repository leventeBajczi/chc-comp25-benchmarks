...
(declare-fun |block_8_while_header_f_21_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_9_while_body_f_20_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
      (and
        (block_6_f_28_30_0 C I A B J G K H L)
        (and (= E 100)
     (= D L)
     (>= L 0)
     (>= D 0)
     ...
     (not (= (<= E D) F)))
      ...
      (block_8_while_header_f_21_30_0 C I A B J G K H L)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (block_9_while_body_f_20_30_0 C K A B L I M J N)
        (and (= F 1)
     (= D N)
     (= O H)
     (= H G)
     ...
     (= E N))
      ...
      (block_8_while_header_f_21_30_0 C K A B L I M J O)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
     ...
     (not (= (<= E D) F)))
      ...
      (block_9_while_body_f_20_30_0 C I A B J G K H L)
    )
  )
)
(assert
