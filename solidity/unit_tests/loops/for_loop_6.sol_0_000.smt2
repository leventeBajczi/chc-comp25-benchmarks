...
(declare-fun |block_8_for_header_f_20_29_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
(declare-fun |block_5_function_f__28_29_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
(declare-fun |block_9_for_body_f_19_29_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) (M Int) (N Int) ) 
    (=>
     ...
     (= E M))
      ...
      (block_8_for_header_f_20_29_0 C I A B J G K H L N)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (block_9_for_body_f_19_29_0 C I A B J G K H L M)
        (and (= D M)
     (= N F)
     (= F E)
     (>= D 0)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) (M Int) ) 
    (=>
      (and
        (block_8_for_header_f_20_29_0 C I A B J G K H L M)
        (and (= D L)
     (= E 10)
     (>= D 0)
     (<= D
