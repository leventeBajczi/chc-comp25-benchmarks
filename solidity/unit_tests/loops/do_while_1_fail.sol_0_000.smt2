...
(declare-fun |block_8_do_while_header_f_21_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
(declare-fun |block_10_f_28_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
(declare-fun |block_6_f_28_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
(declare-fun |block_11_function_f__29_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
(declare-fun |block_5_function_f__29_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_9_do_while_body_f_17_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_7_return_function_f__29_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
(declare-fun |block_12_function_f__29_30_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_5_function_f__29_30_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_6_f_28_30_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L state_type) (M state_type) (N Int) (O tx_type) (P Int) (Q Int) (R Int) ) 
    (=>
      (and
        (block_6_f_28_30_0 C N A B O L P M Q)
        (and (= I Q)
     (= H G)
     (= G (+ E F))
     (= F 1)
     ...
     (not (= (<= J I) K)))
      ...
      (block_8_do_while_header_f_21_30_0 C N A B O L P M R)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (block_9_do_while_body_f_17_30_0 C K A B L I M J N)
        (and (= E N)
     (= D N)
     (= O H)
     (= H G)
     ...
     (= F 1))
      ...
      (block_8_do_while_header_f_21_30_0 C K A B L I M J O)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
      (and
        (block_8_do_while_header_f_21_30_0 C I A B J G K H L)
        (and (= E 10)
     (= D L)
     (>= D 0)
     (<= D
     ...
     (not (= (<= E D) F)))
      ...
      (block_9_do_while_body_f_17_30_0 C I A B J G K H L)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
     ...
     (not (= (<= E D) F)))
      ...
      (block_10_f_28_30_0 C I A B J G K H L)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_10_f_28_30_0 C J A B K H L I M)
        (and (= D 1)
     (= F 14)
     (= E M)
     (>= E 0)
     ...
     (not (= (<= F E) G)))
      ...
      (block_11_function_f__29_30_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_11_function_f__29_30_0 C F A B G D H E I)
        true
      )
      (summary_3_function_f__29_30_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_7_return_function_f__29_30_0 C F A B G D H E I)
        true
      )
      (summary_3_function_f__29_30_0 C F A B G D H E I)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (not (= (<= F E) G)))
      ...
      (block_7_return_function_f__29_30_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_12_function_f__29_30_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (block_12_function_f__29_30_0 C J A B K F L G M)
        (summary_3_function_f__29_30_0 D J A B K H M I N)
  ...
  (and (= H (state_type a!1))
      ...
      (summary_4_function_f__29_30_0 D J A B K F L I N)
    )
  )
)
(assert
