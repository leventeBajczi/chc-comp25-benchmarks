...
(declare-datatypes ((|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr_input| 0) (|uint_array_tuple| 0)) (((|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr_input|  (|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr_input_0| Int) (|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr_input_1| uint_array_tuple)))
...
(declare-datatypes ((|abi_type| 0)) (((|abi_type|  (|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_slice_t_bytes_memory_ptr| (Array |t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_slice_t_bytes_memory_ptr_input|
       bytes_tuple)) (|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr| (Array |t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr_input|
       bytes_tuple))))))
...
(declare-fun |summary_4_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple ) Bool)
(declare-fun |implicit_constructor_entry_17_C_120_0| ( Int Int abi_type crypto_type tx_type state_type state_type ) Bool)
(declare-fun |block_6_abiEncodeSlice_118_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |summary_3_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple ) Bool)
...
(declare-fun |block_8_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
...
(declare-fun |block_9_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |array_slice_uint_array_tuple_0| ( (Array Int Int) (Array Int Int) Int Int ) Bool)
(declare-fun |block_10_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |block_7_return_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |block_12_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |block_11_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |contract_initializer_after_init_16_C_120_0| ( Int Int abi_type crypto_type tx_type state_type state_type ) Bool)
(declare-fun |block_5_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)
(declare-fun |block_13_function_abiEncodeSlice__119_120_0| ( Int Int abi_type crypto_type tx_type state_type Int uint_array_tuple state_type Int uint_array_tuple bytes_tuple bytes_tuple bytes_tuple bytes_tuple Int Int bytes_tuple bytes_tuple ) Bool)

(assert
  (forall ( (A abi_type) (B bytes_tuple) (C bytes_tuple) (D bytes_tuple) (E bytes_tuple) (F bytes_tuple) (G bytes_tuple) (H crypto_type) (I uint_array_tuple) (J uint_array_tuple) (K Int) (L Int) (M Int) (N state_type) (O state_type) (P Int) (Q tx_type) (R Int) (S Int) ) 
    (=>
      (and
        true
      )
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D abi_type) (E bytes_tuple) (F bytes_tuple) (G bytes_tuple) (H bytes_tuple) (I bytes_tuple) (J bytes_tuple) (K bytes_tuple) (L bytes_tuple) (M crypto_type) (N uint_array_tuple) (O uint_array_tuple) (P Int) (Q Int) (R Int) (S uint_array_tuple) (T bytes_tuple) (U Int) (V uint_array_tuple) (W Int) (X uint_array_tuple) (Y bytes_tuple) (Z bytes_tuple) (A1 Int) (B1 bytes_tuple) (C1 Int) (D1 Bool) (E1 Int) (F1 Int) (G1 state_type) (H1 state_type) (I1 Int) (J1 tx_type) (K1 Int) (L1 Int) ) 
    (=>
      (and
        (block_6_abiEncodeSlice_118_120_0 P I1 D M J1 G1 E1 N H1 F1 O E G I J K1 L1 K L)
        (array_slice_uint_array_tuple_0 C B W A)
        (and (= B (uint_array_tuple_accessor_array X))
     (= Z F)
     (= Y
     ...
     (= H Y)
     (= T
        (select (|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr|
                  D)
                (|t_function_abiencodewithselector_pure(t_bytes4)returns(t_bytes_memory_ptr)_t_bytes4_t_array(t_uint256)dyn_calldata_ptr_t_bytes_memory_ptr_input|
                  R
                  S)))
     ...
     (<= F1 4294967295)
     (not D1)
     (= C (uint_array_tuple_accessor_array V)))
      )
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F abi_type) (G bytes_tuple) (H bytes_tuple) (I bytes_tuple) (J bytes_tuple) (K bytes_tuple) (L bytes_tuple) (M bytes_tuple) (N bytes_tuple) (O bytes_tuple) (P crypto_type) (Q uint_array_tuple) (R uint_array_tuple) (S Int) (T Int) (U Int) (V Int) (W uint_array_tuple) (X bytes_tuple) (Y Int) (Z uint_array_tuple) (A1 Int) (B1 uint_array_tuple) (C1 bytes_tuple) (D1 bytes_tuple) (E1 Int) (F1 bytes_tuple) (G1 Int) (H1 Bool) (I1 Int) (J1 uint_array_tuple) (K1 uint_array_tuple) (L1 Int) (M1 uint_array_tuple) (N1 bytes_tuple) (O1 bytes_tuple) (P1 Int) (Q1 bytes_tuple) (R1 Int) (S1 Bool) (T1 Int) (U1 Int) (V1 state_type) (W1 state_type) (X1 Int) (Y1 tx_type) (Z1 Int) (A2 Int) (v_53 Int) ) 
    (=>
      (and
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F (Array Int Int)) (G (Array Int Int)) (H abi_type) (I bytes_tuple) (J bytes_tuple) (K bytes_tuple) (L bytes_tuple) (M bytes_tuple) (N bytes_tuple) (O bytes_tuple) (P bytes_tuple) (Q bytes_tuple) (R bytes_tuple) (S crypto_type) (T uint_array_tuple) (U uint_array_tuple) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 uint_array_tuple) (B1 bytes_tuple) (C1 Int) (D1 uint_array_tuple) (E1 Int) (F1 uint_array_tuple) (G1 bytes_tuple) (H1 bytes_tuple) (I1 Int) (J1 bytes_tuple) (K1 Int) (L1 Bool) (M1 Int) (N1 uint_array_tuple) (O1 uint_array_tuple) (P1 Int) (Q1 uint_array_tuple) (R1 bytes_tuple) (S1 bytes_tuple) (T1 Int) (U1 bytes_tuple) (V1 Int) (W1 Bool) (X1 Int) (Y1 uint_array_tuple) (Z1 Int) (A2 Int) (B2 uint_array_tuple) (C2 bytes_tuple) (D2 bytes_tuple) (E2 Int) (F2 bytes_tuple) (G2 Int) (H2 Bool) (I2 Int) (J2 Int) (K2 state_type) (L2 state_type) (M2 Int) (N2 tx_type) (O2 Int) (P2 Int) (v_68 Int) ) 
    (=>
      (and
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F (Array Int Int)) (G (Array Int Int)) (H (Array Int Int)) (I (Array Int Int)) (J abi_type) (K bytes_tuple) (L bytes_tuple) (M bytes_tuple) (N bytes_tuple) (O bytes_tuple) (P bytes_tuple) (Q bytes_tuple) (R bytes_tuple) (S bytes_tuple) (T bytes_tuple) (U bytes_tuple) (V crypto_type) (W uint_array_tuple) (X uint_array_tuple) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 uint_array_tuple) (F1 bytes_tuple) (G1 Int) (H1 uint_array_tuple) (I1 Int) (J1 uint_array_tuple) (K1 bytes_tuple) (L1 bytes_tuple) (M1 Int) (N1 bytes_tuple) (O1 Int) (P1 Bool) (Q1 Int) (R1 uint_array_tuple) (S1 uint_array_tuple) (T1 Int) (U1 uint_array_tuple) (V1 bytes_tuple) (W1 bytes_tuple) (X1 Int) (Y1 bytes_tuple) (Z1 Int) (A2 Bool) (B2 Int) (C2 uint_array_tuple) (D2 Int) (E2 Int) (F2 uint_array_tuple) (G2 bytes_tuple) (H2 bytes_tuple) (I2 Int) (J2 bytes_tuple) (K2 Int) (L2 Bool) (M2 Int) (N2 Int) (O2 Int) (P2 uint_array_tuple) (Q2 Int) (R2 Int) (S2 uint_array_tuple) (T2 bytes_tuple) (U2 bytes_tuple) (V2 Int) (W2 bytes_tuple) (X2 Int) (Y2 Bool) (Z2 Int) (A3 Int) (B3 state_type) (C3 state_type) (D3 Int) (E3 tx_type) (F3 Int) (G3 Int) (H3 Int) (I3 Int) (v_87 Int) ) 
    (=>
      (and
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F (Array Int Int)) (G (Array Int Int)) (H (Array Int Int)) (I (Array Int Int)) (J (Array Int Int)) (K (Array Int Int)) (L abi_type) (M bytes_tuple) (N bytes_tuple) (O bytes_tuple) (P bytes_tuple) (Q bytes_tuple) (R bytes_tuple) (S bytes_tuple) (T bytes_tuple) (U bytes_tuple) (V bytes_tuple) (W bytes_tuple) (X bytes_tuple) (Y crypto_type) (Z uint_array_tuple) (A1 uint_array_tuple) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 uint_array_tuple) (J1 Int) (K1 Int) (L1 uint_array_tuple) (M1 bytes_tuple) (N1 bytes_tuple) (O1 Int) (P1 bytes_tuple) (Q1 Int) (R1 Bool) (S1 Int) (T1 uint_array_tuple) (U1 bytes_tuple) (V1 Int) (W1 uint_array_tuple) (X1 Int) (Y1 uint_array_tuple) (Z1 bytes_tuple) (A2 bytes_tuple) (B2 Int) (C2 bytes_tuple) (D2 Int) (E2 Bool) (F2 Int) (G2 uint_array_tuple) (H2 uint_array_tuple) (I2 Int) (J2 uint_array_tuple) (K2 bytes_tuple) (L2 bytes_tuple) (M2 Int) (N2 bytes_tuple) (O2 Int) (P2 Bool) (Q2 Int) (R2 uint_array_tuple) (S2 Int) (T2 Int) (U2 uint_array_tuple) (V2 bytes_tuple) (W2 bytes_tuple) (X2 Int) (Y2 bytes_tuple) (Z2 Int) (A3 Bool) (B3 Int) (C3 Int) (D3 Int) (E3 uint_array_tuple) (F3 Int) (G3 Int) (H3 uint_array_tuple) (I3 bytes_tuple) (J3 bytes_tuple) (K3 Int) (L3 bytes_tuple) (M3 Int) (N3 Bool) (O3 Int) (P3 Int) (Q3 state_type) (R3 state_type) (S3 Int) (T3 tx_type) (U3 Int) (V3 Int) (W3 Int) (X3 Int) (v_102 Int) ) 
    (=>
      (and
...
(assert
  (forall ( (A abi_type) (B bytes_tuple) (C bytes_tuple) (D bytes_tuple) (E bytes_tuple) (F bytes_tuple) (G bytes_tuple) (H crypto_type) (I uint_array_tuple) (J uint_array_tuple) (K uint_array_tuple) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R state_type) (S state_type) (T state_type) (U state_type) (V Int) (W tx_type) (X Int) (Y Int) ) 
    (=>
      (and
        (block_13_function_abiEncodeSlice__119_120_0
  L
  ...
  G)
      ...
      (a!2 (= (select (bytes_tuple_accessor_array (msg.data W)) 3) 42))
      (a!3 (= (select (bytes_tuple_accessor_array (msg.data W)) 2) 48))
      (a!4 (= (select (bytes_tuple_accessor_array (msg.data W)) 1) 190))
      (a!5 (= (select (bytes_tuple_accessor_array (msg.data W)) 0) 241))
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C uint_array_tuple) (D uint_array_tuple) (E Int) (F Int) (G Int) (H state_type) (I state_type) (J Int) (K tx_type) ) 
    (=>
      (and
