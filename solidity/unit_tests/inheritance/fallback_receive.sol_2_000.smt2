...
(declare-fun |block_16_fallback_12_23_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_20_fallback_12_23_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_18_return_fallback_12_23_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_16_fallback_12_23_0 C F A B G D H E I)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_19_fallback_12_23_0 D J A B K H L I M)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_18_return_fallback_12_23_0 C F A B G D H E I)
        true
      )
      (summary_3_fallback_12_23_0 C F A B G D H E I)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_18_return_fallback_12_23_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_20_fallback_12_23_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (block_20_fallback_12_23_0 C J A B K F L G M)
