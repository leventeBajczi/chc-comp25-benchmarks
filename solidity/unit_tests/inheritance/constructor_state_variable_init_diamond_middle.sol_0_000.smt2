...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_21_constructor_20_21_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_22__19_21_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_22__19_21_0 C J A B K H L I M)
        (and (= D 1)
     (= F 1)
     (= E M)
     (>= E 0)
     ...
     (= G (= E F)))
      ...
      (block_24_constructor_20_21_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_24_constructor_20_21_0 C F A B G D H E I)
        true
      )
      (summary_6_constructor_20_21_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_23_return_constructor_20_21_0 C F A B G D H E I)
        true
      )
      (summary_6_constructor_20_21_0 C F A B G D H E I)
    )
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J Int) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) (Q Int) ) 
    (=>
      (and
        (block_22__19_21_0 C M A B N K O L P)
        (and (= E P)
     (= D C)
     (= F 1)
     (= H P)
     ...
     (= G (= E F)))
      ...
      (block_23_return_constructor_20_21_0 D M A B N K O L Q)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_entry_26_B_21_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_after_init_27_B_21_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E state_type) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) (L Int) ) 
    (=>
      (and
        (contract_initializer_after_init_27_B_21_0 C H A B I E J F K)
        (summary_6_constructor_20_21_0 D H A B I F K G L)
        (not (<= D 0))
      )
      (contract_initializer_25_B_21_0 D H A B I E J G L)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_entry_29_A_4_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (contract_initializer_entry_29_A_4_0 C G A B H E F I J)
        (and (= K D) (= D 1))
      )
      (contract_initializer_after_init_30_A_4_0 C G A B H E F I K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (contract_initializer_after_init_30_A_4_0 C F A B G D E H I)
        true
      )
      (contract_initializer_28_A_4_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (implicit_constructor_entry_31_B_21_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E state_type) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) (L Int) ) 
    (=>
      (and
        (implicit_constructor_entry_31_B_21_0 C H A B I E J F K)
        (contract_initializer_28_A_4_0 D H A B I F G K L)
        (not (<= D 0))
      )
      (summary_constructor_5_B_21_0 D H A B I E J G L)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (contract_initializer_28_A_4_0 D J A B K G H M N)
        (implicit_constructor_entry_31_B_21_0 C J A B K F L G M)
        (contract_initializer_25_B_21_0 E J A B K H N I O)
        (and (not (<= E 0)) (= D 0))
      )
      (summary_constructor_5_B_21_0 E J A B K F L I O)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (summary_constructor_5_B_21_0 C F A B G D H E I)
        (and (= C 1)
     (>= (tx.origin G) 0)
     (>= (tx.gasprice G) 0)
     (>= (msg.value G) 0)
