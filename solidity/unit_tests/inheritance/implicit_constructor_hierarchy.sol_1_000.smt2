...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_39_function_f__47_48_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_40_f_46_48_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_40_f_46_48_0 C J A B K H L I M)
        (and (= F 2)
     (= E M)
     (= D 4)
     (>= E 0)
     ...
     (= G (= E F)))
      ...
      (block_42_function_f__47_48_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_42_function_f__47_48_0 C F A B G D H E I)
        true
      )
      (summary_14_function_f__47_48_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_41_return_function_f__47_48_0 C F A B G D H E I)
        true
      )
      (summary_14_function_f__47_48_0 C F A B G D H E I)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_41_return_function_f__47_48_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_43_function_f__47_48_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (block_43_function_f__47_48_0 C J A B K F L G M)
        (summary_14_function_f__47_48_0 D J A B K H M I N)
  ...
  (and (= G F)
      ...
      (summary_15_function_f__47_48_0 D J A B K F L I N)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (summary_15_function_f__47_48_0 C F A B G D H E I)
        (interface_9_C_48_0 F A B D H)
        (= C 0)
      )
      (interface_9_C_48_0 F A B E I)
    )
  )
)
(assert
