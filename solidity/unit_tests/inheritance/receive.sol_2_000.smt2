...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_15_receive_12_23_0 C F A B G D H E I)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_18_receive_12_23_0 D J A B K H L I M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_18_receive_12_23_0 C F A B G D H E I)
        true
      )
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_17_return_receive_12_23_0 C F A B G D H E I)
        true
      )
      (summary_3_receive_12_23_0 C F A B G D H E I)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_17_return_receive_12_23_0 D J A B K H L I M)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (block_19_receive_12_23_0 C J A B K F L G M)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (summary_14_receive_38_39_0 C F A B G D J H E K I)
        (interface_7_B_39_0 F A B D J H)
        (= C 0)
      )
      (interface_7_B_39_0 F A B E K I)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      ...
      (block_38_receive_38_39_0 C F A B G D J H E K I)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) (O Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_41_receive_38_39_0 D J A B K H N L I O M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (block_41_receive_38_39_0 C F A B G D J H E K I)
        true
      )
      (summary_13_receive_38_39_0 C F A B G D J H E K I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (block_40_return_receive_38_39_0 C F A B G D J H E K I)
        true
      )
      (summary_13_receive_38_39_0 C F A B G D J H E K I)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) (O Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_40_return_receive_38_39_0 D J A B K H N L I O M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      ...
      (block_42_receive_38_39_0 C F A B G D J H E K I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) ) 
    (=>
      (and
        (block_42_receive_38_39_0 C J A B K F O L G P M)
        (summary_13_receive_38_39_0 D J A B K H P M I Q N)
        (let ((a!1 (>= (+ (select (balances G) J) E) 0))
      (a!2 (<= (+ (select (balances G) J) E)
               115792089237316195423570985008687907853269984665640564039457584007913129639935))
      (a!3 (store (balances G) J (+ (select (balances G) J) E))))
  (and (= G F)
      ...
      (summary_14_receive_38_39_0 D J A B K F O L I Q N)
    )
  )
)
(assert
