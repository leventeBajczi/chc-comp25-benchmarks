...
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      ...
      (summary_3_function_f__11_30_0 D G B C H E I F J A)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) ) 
    (=>
      ...
      (block_6_function_g__29_30_0 C F A B G D H E I J)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) ) 
    (=>
      ...
      (block_7_g_28_30_0 C F A B G D H E I J)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      ...
      (summary_9_function_f__11_30_0 D G B C H E I F J A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) (M Int) (N Int) (v_14 state_type) ) 
    (=>
      (and
        (block_7_g_28_30_0 D I B C J G L H M N)
        (summary_9_function_f__11_30_0 E I B C J H F v_14 K A)
        (and (= v_14 H)
     (= F M)
     (>= F 0)
     (>= M 0)
     ...
     (= N 0))
      ...
      (summary_4_function_g__29_30_0 E I B C J G L H M)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (block_10_function_g__29_30_0 C F A B G D H E I J)
        true
      )
      (summary_4_function_g__29_30_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (block_8_return_function_g__29_30_0 C F A B G D H E I J)
        true
      )
      (summary_4_function_g__29_30_0 C F A B G D H E I)
    )
...
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L state_type) (M state_type) (N Int) (O tx_type) (P Int) (Q Int) (R Int) (S Int) (T Int) (v_20 state_type) ) 
    (=>
      (and
        (block_7_g_28_30_0 D N B C O L Q M R S)
        (summary_9_function_f__11_30_0 E N B C O M G v_20 P A)
        (and (= v_20 M)
     (= J R)
     (= E 0)
     (= G R)
     ...
     (= K (= I J)))
      ...
      (block_10_function_g__29_30_0 F N B C O L Q M R T)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L state_type) (M state_type) (N Int) (O tx_type) (P Int) (Q Int) (R Int) (S Int) (T Int) (v_20 state_type) ) 
    (=>
     ...
     (= K (= I J)))
      ...
      (block_8_return_function_g__29_30_0 F N B C O L Q M R T)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) (J Int) ) 
    (=>
      ...
      (block_11_function_g__29_30_0 C F A B G D H E I J)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (block_11_function_g__29_30_0 C J A B K F L G M O)
        (summary_4_function_g__29_30_0 D J A B K H M I N)
  ...
  (and (= G F)
      ...
      (summary_5_function_g__29_30_0 D J A B K F L I N)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (summary_5_function_g__29_30_0 C F A B G D H E I)
