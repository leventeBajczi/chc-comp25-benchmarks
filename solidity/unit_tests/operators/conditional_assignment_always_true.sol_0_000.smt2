...
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E crypto_type) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) ) 
    (=>
      (and
        true
      )
      (block_5_function_f__23_24_0 F I A E J G B H C D)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E crypto_type) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) ) 
    (=>
      ...
      (block_6_f_22_24_0 F I A E J G B H C D)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E Int) (F crypto_type) (G Int) (H Int) (I Bool) (J Int) (K Int) (L Int) (M Int) (N Int) (O Bool) (P Bool) (Q state_type) (R state_type) (S Int) (T tx_type) ) 
    (=>
      (and
        (block_6_f_22_24_0 G S A F T Q B R C D)
        (and (= P C)
     (= I C)
     (= H 1)
     (= E L)
     ...
     (not (= (<= N M) O)))
      ...
      (block_8_function_f__23_24_0 H S A F T Q B R C E)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E crypto_type) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) ) 
    (=>
      (and
        (block_8_function_f__23_24_0 F I A E J G B H C D)
        true
      )
      (summary_3_function_f__23_24_0 F I A E J G B H C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E crypto_type) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) ) 
    (=>
      (and
        (block_7_return_function_f__23_24_0 F I A E J G B H C D)
        true
      )
      (summary_3_function_f__23_24_0 F I A E J G B H C)
    )
  ...
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E Int) (F crypto_type) (G Int) (H Int) (I Bool) (J Int) (K Int) (L Int) (M Int) (N Int) (O Bool) (P Bool) (Q state_type) (R state_type) (S Int) (T tx_type) ) 
    (=>
     ...
     (not (= (<= N M) O)))
      ...
      (block_7_return_function_f__23_24_0 H S A F T Q B R C E)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Int) (E crypto_type) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) ) 
    (=>
      ...
      (block_9_function_f__23_24_0 F I A E J G B H C D)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Bool) (E Int) (F crypto_type) (G Int) (H Int) (I Int) (J state_type) (K state_type) (L state_type) (M state_type) (N Int) (O tx_type) ) 
    (=>
      (and
        (block_9_function_f__23_24_0 G N A F O J B K C E)
        (summary_3_function_f__23_24_0 H N A F O L C M D)
  ...
  (and (= L (state_type a!1))
      ...
      (summary_4_function_f__23_24_0 H N A F O J B M D)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      (and
        (summary_4_function_f__23_24_0 E H A D I F B G C)
        (interface_0_C_24_0 H A D F)
        (= E 0)
      )
      (interface_0_C_24_0 H A D G)
    )
  )
)
(assert
