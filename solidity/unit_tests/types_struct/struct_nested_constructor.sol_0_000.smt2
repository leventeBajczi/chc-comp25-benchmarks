...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F |struct C.S|) (G |struct C.S|) (H Int) (I |struct C.T|) (J |struct C.T|) (K Int) (L Int) (M Bool) (N |struct C.S|) (O |struct C.S|) (P |struct C.T|) (Q |struct C.T|) (R state_type) (S state_type) (T Int) (U tx_type) ) 
    (=>
      (and
        (block_6_test_50_52_0 C T A B U R S N P)
        (and (= G (|struct C.T_accessor_s| I))
     (= G O)
     (= N (|struct C.S| 0))
     (= J Q)
     (= Q I)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G |struct C.S|) (H |struct C.S|) (I Int) (J |struct C.T|) (K |struct C.T|) (L Int) (M Int) (N Bool) (O |struct C.T|) (P |struct C.S|) (Q Int) (R Int) (S Bool) (T |struct C.S|) (U |struct C.S|) (V |struct C.T|) (W |struct C.T|) (X state_type) (Y state_type) (Z Int) (A1 tx_type) ) 
    (=>
      (and
        (block_6_test_50_52_0 C Z A B A1 X Y T V)
        (and (= U G)
     (= H (|struct C.T_accessor_s| J))
     (= H U)
     (= T (|struct C.S| 0))
     (= O W)
     (= W J)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H |struct C.S|) (I |struct C.S|) (J Int) (K |struct C.T|) (L |struct C.T|) (M Int) (N Int) (O Bool) (P |struct C.T|) (Q |struct C.S|) (R Int) (S Int) (T Bool) (U |struct C.T|) (V |struct C.S|) (W Int) (X Int) (Y Bool) (Z |struct C.S|) (A1 |struct C.S|) (B1 |struct C.T|) (C1 |struct C.T|) (D1 state_type) (E1 state_type) (F1 Int) (G1 tx_type) ) 
    (=>
      (and
