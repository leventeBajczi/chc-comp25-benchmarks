...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_6_function_f__18_40_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_7_f_17_40_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L state_type) (M state_type) (N Int) (O tx_type) (P Int) (Q Int) (R Int) ) 
    (=>
      (and
        (block_7_f_17_40_0 C N A B O L P M Q)
        (and (= H G)
     (= G (+ E F))
     (= F 1)
     (= E Q)
     ...
     (not (= (<= J I) K)))
      ...
      (block_8_return_function_f__18_40_0 C N A B O L P M R)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_8_return_function_f__18_40_0 C F A B G D H E I)
        true
      )
      (summary_3_function_f__18_40_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (block_9_function_g__39_40_0 E H A D I F J B G K C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (block_10_g_38_40_0 E H A D I F J B G K C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (block_10_g_38_40_0 E K A D L I M B J N C)
        (and (= G 0)
     (= F N)
     (= O H)
     (>= H 0)
     ...
     (= H G))
      ...
      (block_12_if_header_g_31_40_0 E K A D L I M B J O C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
      (and
        (block_12_if_header_g_31_40_0 E I A D J G K B H L C)
        (and (= F true) (= F C))
      )
      (block_13_if_true_g_30_40_0 E I A D J G K B H L C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Bool) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
      ...
      (block_14_g_38_40_0 E I A D J G K B H L C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Int) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (summary_15_function_f__18_40_0 F J A D K H M I N)
        (block_13_if_true_g_30_40_0 E J A D K G L B H M C)
        (= F 0)
      )
      (block_14_g_38_40_0 F J A D K G L B I N C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (summary_15_function_f__18_40_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Int) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      ...
      (summary_4_function_g__39_40_0 F J A D K G L B I N C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (block_16_function_g__39_40_0 E H A D I F J B G K C)
        true
      )
      (summary_4_function_g__39_40_0 E H A D I F J B G K C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (block_11_return_function_g__39_40_0 E H A D I F J B G K C)
        true
      )
      (summary_4_function_g__39_40_0 E H A D I F J B G K C)
    )
...
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I Bool) (J state_type) (K state_type) (L Int) (M tx_type) (N Int) (O Int) ) 
    (=>
      (and
        (block_14_g_38_40_0 E L A D M J N B K O C)
        (and (= H 0)
     (= G O)
     (= F 1)
     (>= G 0)
     ...
     (= I (= G H)))
      ...
      (block_16_function_g__39_40_0 F L A D M J N B K O C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I Bool) (J state_type) (K state_type) (L Int) (M tx_type) (N Int) (O Int) ) 
    (=>
     ...
     (= I (= G H)))
      ...
      (block_11_return_function_g__39_40_0 F L A D M J N B K O C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (block_17_function_g__39_40_0 E H A D I F J B G K C)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D Bool) (E crypto_type) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) (Q Int) ) 
    (=>
      (and
        (block_17_function_g__39_40_0 F M A E N I O B J P C)
        (summary_4_function_g__39_40_0 G M A E N K P C L Q D)
  ...
  (and (= K (state_type a!1))
      ...
      (summary_5_function_g__39_40_0 G M A E N I O B L Q D)
    )
  )
)
(assert
  (forall ( (A abi_type) (B Bool) (C Bool) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (summary_5_function_g__39_40_0 E H A D I F J B G K C)
        (interface_0_C_40_0 H A D F J)
        (= E 0)
      )
      (interface_0_C_40_0 H A D G K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (summary_constructor_2_C_40_0 C F A B G D E H I)
        (and (= C 0)
     (>= (tx.origin G) 0)
     (>= (tx.gasprice G) 0)
     (>= (msg.value G) 0)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_entry_19_C_40_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_after_init_20_C_40_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_18_C_40_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (implicit_constructor_entry_21_C_40_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E state_type) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) (L Int) ) 
    (=>
      (and
        (implicit_constructor_entry_21_C_40_0 C H A B I E F J K)
        (contract_initializer_18_C_40_0 D H A B I F G K L)
        (not (<= D 0))
      )
      (summary_constructor_2_C_40_0 D H A B I E G J L)
    )
  )
)
(assert
