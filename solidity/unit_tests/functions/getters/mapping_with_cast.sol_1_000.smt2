...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D |mapping(bytes16 => uint256)_tuple|) (E |mapping(bytes16 => uint256)_tuple|) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) ) 
    (=>
      (and
        true
      )
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E bytes_tuple) (F Int) (G Int) (H |mapping(bytes16 => uint256)_tuple|) (I bytes_tuple) (J Int) (K Bool) (L Int) (M |mapping(bytes16 => uint256)_tuple|) (N |mapping(bytes16 => uint256)_tuple|) (O state_type) (P state_type) (Q Int) (R tx_type) (S Int) (T Int) ) 
    (=>
      (and
        (block_6_f_28_30_0 C Q A B R O M P N S)
        (and (= H N)
     (= (select (bytes_tuple_accessor_array E) 1) 111)
     (= (select (bytes_tuple_accessor_array E) 2) 111)
     (= (select (bytes_tuple_accessor_array E) 0) 102)
     (= (select (bytes_tuple_accessor_array I) 1) 111)
     (= (select (bytes_tuple_accessor_array I) 2) 111)
     (= (select (bytes_tuple_accessor_array I) 0) 102)
     (= (bytes_tuple_accessor_length E) 3)
     (= (bytes_tuple_accessor_length I) 3)
     (= J
        (select (|mapping(bytes16 => uint256)_tuple_accessor_array| N)
                136159851868824790238372263386031325184))
     (= F
        (select (|mapping(bytes16 => uint256)_tuple_accessor_array| N)
                136159851868824790238372263386031325184))
     (= G T)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F bytes_tuple) (G Int) (H Int) (I |mapping(bytes16 => uint256)_tuple|) (J bytes_tuple) (K Int) (L Bool) (M Int) (N Int) (O Bool) (P Int) (Q |mapping(bytes16 => uint256)_tuple|) (R |mapping(bytes16 => uint256)_tuple|) (S state_type) (T state_type) (U Int) (V tx_type) (W Int) (X Int) ) 
    (=>
      (and
     ...
     (= (select (bytes_tuple_accessor_array F) 1) 111)
     (= (select (bytes_tuple_accessor_array F) 2) 111)
     (= (select (bytes_tuple_accessor_array F) 0) 102)
     (= (bytes_tuple_accessor_length J) 3)
     (= (bytes_tuple_accessor_length F) 3)
     (= N 1)
     (= K
        (select (|mapping(bytes16 => uint256)_tuple_accessor_array| R)
                136159851868824790238372263386031325184))
     (= H X)
     (= G
        (select (|mapping(bytes16 => uint256)_tuple_accessor_array| R)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F |mapping(bytes16 => uint256)_tuple|) (G |mapping(bytes16 => uint256)_tuple|) (H |mapping(bytes16 => uint256)_tuple|) (I state_type) (J state_type) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) ) 
    (=>
      (and
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D |mapping(bytes16 => uint256)_tuple|) (E |mapping(bytes16 => uint256)_tuple|) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      (and
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D |mapping(bytes16 => uint256)_tuple|) (E |mapping(bytes16 => uint256)_tuple|) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
     ...
     (= E
        (|mapping(bytes16 => uint256)_tuple| ((as const (Array Int Int)) 0) 0)))
      )
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E |mapping(bytes16 => uint256)_tuple|) (F |mapping(bytes16 => uint256)_tuple|) (G |mapping(bytes16 => uint256)_tuple|) (H state_type) (I state_type) (J state_type) (K Int) (L tx_type) ) 
    (=>
      (and
