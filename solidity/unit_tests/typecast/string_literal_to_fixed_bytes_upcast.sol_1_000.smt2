...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E bytes_tuple) (F Int) (G Bool) (H bytes_tuple) (I Int) (J state_type) (K state_type) (L Int) (M tx_type) ) 
    (=>
      (and
        (block_6_f_27_29_0 C L A B M J K)
        (and (= (select (bytes_tuple_accessor_array H) 3) 255)
     (= (select (bytes_tuple_accessor_array H) 2) 255)
     (= (select (bytes_tuple_accessor_array H) 1) 0)
     (= (select (bytes_tuple_accessor_array H) 0) 0)
     (= (select (bytes_tuple_accessor_array E) 1) 255)
     (= (select (bytes_tuple_accessor_array E) 0) 255)
     ...
     (= G (= I F)))
      ...
      (block_8_function_f__28_29_0 D L A B M J K)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F bytes_tuple) (G Int) (H Bool) (I bytes_tuple) (J Int) (K bytes_tuple) (L Int) (M Bool) (N bytes_tuple) (O Int) (P state_type) (Q state_type) (R Int) (S tx_type) ) 
    (=>
      (and
        (block_6_f_27_29_0 C R A B S P Q)
        (and (= H (= O G))
     (= (select (bytes_tuple_accessor_array N) 3) 255)
     (= (select (bytes_tuple_accessor_array N) 2) 255)
     (= (select (bytes_tuple_accessor_array N) 1) 0)
     (= (select (bytes_tuple_accessor_array N) 0) 0)
     ...
     (= (select (bytes_tuple_accessor_array I) 3) 0)
     (= (select (bytes_tuple_accessor_array I) 2) 0)
     (= (select (bytes_tuple_accessor_array I) 1) 255)
     (= (select (bytes_tuple_accessor_array I) 0) 255)
     ...
     (= M (= J L)))
      ...
      (block_9_function_f__28_29_0 E R A B S P Q)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F bytes_tuple) (G Int) (H Bool) (I bytes_tuple) (J Int) (K bytes_tuple) (L Int) (M Bool) (N bytes_tuple) (O Int) (P state_type) (Q state_type) (R Int) (S tx_type) ) 
    (=>
     ...
     (= M (= J L)))
      ...
      (block_7_return_function_f__28_29_0 E R A B S P Q)
    )
  )
)
(assert
