...
(declare-fun |block_8_function_f__24_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_9_function_f__24_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      ...
      (block_5_function_f__24_25_0 E H C D I F A G B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      ...
      (block_6_f_23_25_0 E H C D I F A G B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Bool) (I Int) (J Int) (K Int) (L Bool) (M Int) (N Int) (O state_type) (P state_type) (Q Int) (R tx_type) ) 
    (=>
      (and
        (block_6_f_23_25_0 E Q C D R O A P B)
        (and (not (= (= I K) L))
     (= G N)
     (= N 0)
     (= K J)
     ...
     (not (= (= M G) H)))
      ...
      (block_8_function_f__24_25_0 F Q C D R O A P B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      (and
        (block_8_function_f__24_25_0 E H C D I F A G B)
        true
      )
      (summary_3_function_f__24_25_0 E H C D I F A G B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      (and
        (block_7_return_function_f__24_25_0 E H C D I F A G B)
        true
      )
      (summary_3_function_f__24_25_0 E H C D I F A G B)
    )
  ...
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Bool) (I Int) (J Int) (K Int) (L Bool) (M Int) (N Int) (O state_type) (P state_type) (Q Int) (R tx_type) ) 
    (=>
     ...
     (not (= (= M G) H)))
      ...
      (block_7_return_function_f__24_25_0 F Q C D R O A P B)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D abi_type) (E crypto_type) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K state_type) (L state_type) (M Int) (N tx_type) ) 
    (=>
      (and
        (block_9_function_f__24_25_0 F M D E N I A J B)
        (summary_3_function_f__24_25_0 G M D E N K B L C)
  ...
  (and (= J I)
      ...
      (summary_4_function_f__24_25_0 G M D E N I A L C)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      (and
        ...
        (interface_0_C_25_0 H C D F)
        (= E 0)
      )
      (interface_0_C_25_0 H C D G)
    )
  )
)
(assert
