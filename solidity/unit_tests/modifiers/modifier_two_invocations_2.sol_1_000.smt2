...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Bool) (N Bool) (O state_type) (P state_type) (Q Int) (R tx_type) (S Int) (T Int) (U Int) ) 
    (=>
      (and
        (block_6_f_37_39_0 C Q A B R O S P T)
        (and (= N (= J L))
     (= K 0)
     (= J T)
     (= I T)
     ...
     (= M (= I K)))
      ...
      (block_9_return_function_f__38_39_0 C Q A B R O S P U)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M state_type) (N state_type) (O Int) (P tx_type) (Q Int) (R Int) (S Int) ) 
    (=>
      (and
        (block_9_return_function_f__38_39_0 C O A B P M Q N R)
        (and (= I H)
     (= H (+ F G))
     (= G 1)
     (= F R)
     ...
     (= L (<= J K)))
      ...
      (block_10_function_f__38_39_0 D O A B P M Q N S)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M state_type) (N state_type) (O Int) (P tx_type) (Q Int) (R Int) (S Int) ) 
    (=>
     ...
     (= L (<= J K)))
      ...
      (block_8_return_f_24_39_0 D O A B P M Q N S)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M state_type) (N state_type) (O Int) (P tx_type) (Q Int) (R Int) (S Int) ) 
    (=>
      (and
        (block_8_return_f_24_39_0 C O A B P M Q N R)
        (and (= I H)
     (= H (+ F G))
     (= G 1)
     (= F R)
     ...
     (= L (<= J K)))
      ...
      (block_11_function_f__38_39_0 D O A B P M Q N S)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M state_type) (N state_type) (O Int) (P tx_type) (Q Int) (R Int) (S Int) ) 
    (=>
     ...
     (= L (<= J K)))
      ...
      (block_7_return_f_24_39_0 D O A B P M Q N S)
    )
  )
)
(assert
