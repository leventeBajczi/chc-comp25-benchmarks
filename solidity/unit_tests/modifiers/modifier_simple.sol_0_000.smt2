...
(declare-fun |block_8_return_function_f__24_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
(declare-fun |block_10_function_f__24_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(declare-fun |block_7_return_f_12_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int ) Bool)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J Bool) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) ) 
    (=>
      (and
        (block_6_f_23_25_0 C M A B N K O L P)
        (and (not (= (<= H I) J))
     (= E P)
     (= I 0)
     (= F 0)
     ...
     (not (= (<= E F) G)))
      ...
      (block_9_function_f__24_25_0 D M A B N K O L P)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_9_function_f__24_25_0 C F A B G D H E I)
        true
      )
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_7_return_f_12_25_0 C F A B G D H E I)
        true
      )
      (summary_3_function_f__24_25_0 C F A B G D H E I)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J Bool) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) ) 
    (=>
     ...
     (not (= (<= E F) G)))
      ...
      (block_8_return_function_f__24_25_0 D M A B N K O L P)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (block_8_return_function_f__24_25_0 C F A B G D H E I)
        true
      )
      (block_7_return_f_12_25_0 C F A B G D H E I)
    )
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (block_10_function_f__24_25_0 C F A B G D H E I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (block_10_function_f__24_25_0 C J A B K F L G M)
