...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Bool) (E Bool) (F state_type) (G state_type) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (nondet_interface_1_C_56_0 C H A B F I D G J E)
        true
      )
      (nondet_call_15_0 C H A B F I D G J E)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I bytes_tuple) (J Bool) (K Bool) (L Bool) (M state_type) (N state_type) (O state_type) (P Int) (Q tx_type) (R Int) (S Int) (T Int) (U Int) (V Int) ) 
    (=>
      (and
        (block_13_f_54_56_0 E P C D Q M R J A N S K B U)
        (nondet_call_15_0 F P C D N S K O T L)
        (and (= (select (bytes_tuple_accessor_array I) 3) 97)
     ...
     (= (select (bytes_tuple_accessor_array I) 4) 97))
      ...
      (summary_5_function_f__55_56_0 F P C D Q M R J A O T L B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I Int) (J bytes_tuple) (K Int) (L Int) (M Bool) (N Bool) (O Bool) (P Bool) (Q state_type) (R state_type) (S state_type) (T Int) (U tx_type) (V Int) (W Int) (X Int) (Y Int) (Z Int) ) 
    (=>
      (and
        (block_13_f_54_56_0 E T C D U Q V N A R W O B Y)
        (nondet_call_15_0 F T C D R W O S X P)
        (and (= (select (bytes_tuple_accessor_array J) 4) 97)
     ...
     (= M (= K L)))
      ...
      (block_16_function_f__55_56_0 G T C D U Q V N A S X P B Z)
    )
  )
)
(assert
  ...
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I Int) (J bytes_tuple) (K Int) (L Int) (M Bool) (N Bool) (O Bool) (P Bool) (Q state_type) (R state_type) (S state_type) (T Int) (U tx_type) (V Int) (W Int) (X Int) (Y Int) (Z Int) ) 
    (=>
     ...
     (= M (= K L)))
      ...
      (block_14_return_function_f__55_56_0 G T C D U Q V N A S X P B Z)
    )
  )
)
(assert
