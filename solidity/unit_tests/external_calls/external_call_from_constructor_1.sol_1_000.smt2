...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (block_20_function_f__36_37_0 C H A B I F D J G E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (block_21_f_35_37_0 C H A B I F D J G E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J state_type) (K state_type) (L Int) (M tx_type) (N Int) (O Int) ) 
    (=>
      (and
        (block_21_f_35_37_0 C L A B M J H N K I O)
        (and (= F 2)
     (= E O)
     (= D 3)
     (>= E 0)
     ...
     (= G (= E F)))
      ...
      (block_23_function_f__36_37_0 D L A B M J H N K I O)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (block_23_function_f__36_37_0 C H A B I F D J G E K)
        true
      )
      (summary_8_function_f__36_37_0 C H A B I F D J G E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (block_22_return_function_f__36_37_0 C H A B I F D J G E K)
        true
      )
      (summary_8_function_f__36_37_0 C H A B I F D J G E K)
    )
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J state_type) (K state_type) (L Int) (M tx_type) (N Int) (O Int) ) 
    (=>
     ...
     (= G (= E F)))
      ...
      (block_22_return_function_f__36_37_0 D L A B M J H N K I O)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (block_24_function_f__36_37_0 C H A B I F D J G E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) (Q Int) ) 
    (=>
      (and
        (block_24_function_f__36_37_0 C M A B N I F O J G P)
        (summary_8_function_f__36_37_0 D M A B N K G P L H Q)
  ...
  (and (= J I)
      ...
      (summary_9_function_f__36_37_0 D M A B N I F O L H Q)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (summary_9_function_f__36_37_0 C H A B I F D J G E K)
        (interface_5_C_37_0 H A B F D J)
        (= C 0)
      )
      (interface_5_C_37_0 H A B G E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (summary_constructor_7_C_37_0 C H A B I F G D J E K)
        (and (= C 0)
     (>= (tx.origin I) 0)
     (>= (tx.gasprice I) 0)
     (>= (msg.value I) 0)
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      ...
      (contract_initializer_entry_26_C_37_0 C H A B I F G D J E K)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J state_type) (K state_type) (L Int) (M tx_type) (N Int) (O Int) (P Int) ) 
    (=>
      (and
        (contract_initializer_entry_26_C_37_0 D L B C M J K H N I O)
        (and (= G A)
     (= F 2)
     (= E I)
     (>= G 0)
     ...
     (= P G))
      ...
      (contract_initializer_after_init_27_C_37_0 D L B C M J K H N I P)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (contract_initializer_after_init_27_C_37_0 C H A B I F G D J E K)
        true
      )
      (contract_initializer_25_C_37_0 C H A B I F G D J E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
     ...
     (= G F))
      ...
      (implicit_constructor_entry_28_C_37_0 C H A B I F G D J E K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H state_type) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (implicit_constructor_entry_28_C_37_0 C K A B L H I E M F N)
        (contract_initializer_25_C_37_0 D K A B L I J F N G O)
        (not (<= D 0))
      )
      (summary_constructor_7_C_37_0 D K A B L H J E M G O)
    )
  )
)
(assert
