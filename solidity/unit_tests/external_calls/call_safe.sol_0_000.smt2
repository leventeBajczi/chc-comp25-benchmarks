...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E Int) (F Int) (v_6 state_type) (v_7 Int) ) 
    (=>
      ...
      (nondet_interface_1_C_24_0 C E A B D F v_6 v_7)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G state_type) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (summary_4_function_f__23_24_0 F J C D K H M A I N B)
        (nondet_interface_1_C_24_0 E J C D G L H M)
        (= E 0)
      )
      (nondet_interface_1_C_24_0 F J C D G L I N)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      ...
      (block_5_function_f__23_24_0 F J C D K H L A I M B G E)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      ...
      (block_6_f_22_24_0 F J C D K H L A I M B G E)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G Int) (H Int) ) 
    (=>
      (and
        (nondet_interface_1_C_24_0 C F A B D G E H)
        true
      )
...
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Int) (H Int) (I bytes_tuple) (J Bool) (K state_type) (L state_type) (M state_type) (N Int) (O tx_type) (P Int) (Q Int) (R Int) ) 
    (=>
      (and
        (block_6_f_22_24_0 F N C D O K P A L Q B J E)
     ...
     (= E (bytes_tuple ((as const (Array Int Int)) 0) 0)))
      ...
      (summary_3_function_f__23_24_0 G N C D O K P A M R B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F bytes_tuple) (G Int) (H Int) (I Int) (J Int) (K bytes_tuple) (L |tuple(bool,bytes)|) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R state_type) (S state_type) (T state_type) (U Int) (V tx_type) (W Int) (X Int) (Y Int) ) 
    (=>
      (and
        (block_6_f_22_24_0 G U C D V R W A S X B P E)
        (nondet_call_8_0 H U C D S X T Y)
        (and (= Q (|tuple(bool,bytes)_accessor_0| L))
     ...
     (= O (= M N)))
      ...
      (block_9_function_f__23_24_0 I U C D V R W A T Y B Q F)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_9_function_f__23_24_0 F J C D K H L A I M B G E)
        true
      )
      (summary_3_function_f__23_24_0 F J C D K H L A I M B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F bytes_tuple) (G Int) (H Int) (I Int) (J Int) (K bytes_tuple) (L |tuple(bool,bytes)|) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R state_type) (S state_type) (T state_type) (U Int) (V tx_type) (W Int) (X Int) (Y Int) ) 
    (=>
     ...
     (= O (= M N)))
      ...
      (block_7_return_function_f__23_24_0 I U C D V R W A T Y B Q F)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_7_return_function_f__23_24_0 F J C D K H L A I M B G E)
        true
      )
      (summary_3_function_f__23_24_0 F J C D K H L A I M B)
    )
...
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Bool) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      ...
      (block_10_function_f__23_24_0 F J C D K H L A I M B G E)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D abi_type) (E crypto_type) (F bytes_tuple) (G Int) (H Int) (I Int) (J Bool) (K state_type) (L state_type) (M state_type) (N state_type) (O Int) (P tx_type) (Q Int) (R Int) (S Int) ) 
    (=>
      (and
        (block_10_function_f__23_24_0 G O D E P K Q A L R B J F)
        (summary_3_function_f__23_24_0 H O D E P M R B N S C)
  ...
  (and (= L K)
      ...
      (summary_4_function_f__23_24_0 H O D E P K Q A N S C)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) ) 
    (=>
      (and
        (summary_4_function_f__23_24_0 E H C D I F J A G K B)
        (interface_0_C_24_0 H C D F J)
        (= E 0)
      )
      (interface_0_C_24_0 H C D G K)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_entry_12_C_24_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_after_init_13_C_24_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (contract_initializer_11_C_24_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      ...
      (implicit_constructor_entry_14_C_24_0 C F A B G D E H I)
    )
  )
)
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E state_type) (F state_type) (G state_type) (H Int) (I tx_type) (J Int) (K Int) (L Int) ) 
    (=>
      (and
        (implicit_constructor_entry_14_C_24_0 C H A B I E F J K)
        (contract_initializer_11_C_24_0 D H A B I F G K L)
        (not (<= D 0))
      )
      (summary_constructor_2_C_24_0 D H A B I E G J L)
    )
  )
)
(assert
...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E state_type) (F Int) (G tx_type) (H Int) (I Int) ) 
    (=>
      (and
        (summary_constructor_2_C_24_0 C F A B G D E H I)
        (and (= C 0)
     (>= (tx.origin G) 0)
     (>= (tx.gasprice G) 0)
     (>= (msg.value G) 0)
