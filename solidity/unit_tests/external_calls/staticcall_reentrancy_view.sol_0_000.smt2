...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D state_type) (E Int) (F Int) (v_6 state_type) (v_7 Int) (v_8 state_type) (v_9 Int) ) 
    (=>
      (and
        (nondet_interface_1_C_34_0 C E A B D F v_6 v_7)
        (and (= v_6 D) (= v_7 F) (= v_8 D) (= v_9 F))
      )
      (nondet_call_14_0 C E A B D F v_8 v_9)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F Int) (G Int) (H Int) (I bytes_tuple) (J Bool) (K state_type) (L state_type) (M Int) (N tx_type) (O Int) (P Int) (v_16 state_type) (v_17 Int) ) 
    (=>
      (and
        (block_12_f_32_34_0 F M C D N K O A L P B J E)
        (nondet_call_14_0 G M C D L P v_16 v_17)
        (and (= v_16 L)
     (= v_17 P)
     ...
     (= E (bytes_tuple ((as const (Array Int Int)) 0) 0)))
      ...
      (summary_5_function_f__33_34_0 G M C D N K O A L P B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F bytes_tuple) (G Int) (H Int) (I Int) (J Int) (K bytes_tuple) (L |tuple(bool,bytes)|) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R state_type) (S state_type) (T Int) (U tx_type) (V Int) (W Int) (v_23 state_type) (v_24 Int) ) 
    (=>
      (and
        (block_12_f_32_34_0 G T C D U R V A S W B P E)
        (nondet_call_14_0 H T C D S W v_23 v_24)
        (and (= v_23 S)
     (= v_24 W)
     (= E (bytes_tuple ((as const (Array Int Int)) 0) 0))
     (= O (= M N))
     ...
     (= F (|tuple(bool,bytes)_accessor_1| L)))
      ...
      (block_15_function_f__33_34_0 I T C D U R V A S W B Q F)
    )
  )
)
(assert
  ...
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E bytes_tuple) (F bytes_tuple) (G Int) (H Int) (I Int) (J Int) (K bytes_tuple) (L |tuple(bool,bytes)|) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R state_type) (S state_type) (T Int) (U tx_type) (V Int) (W Int) (v_23 state_type) (v_24 Int) ) 
    (=>
     ...
     (= F (|tuple(bool,bytes)_accessor_1| L)))
      ...
      (block_13_return_function_f__33_34_0 I T C D U R V A S W B Q F)
    )
  )
)
(assert
