...
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      ...
      (block_5_function_f__25_26_0 D G B C H E I F J A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      ...
      (block_6_f_24_26_0 D G B C H E I F J A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
      (and
        (block_6_f_24_26_0 E I C D J G K H L A)
        (and (= B F)
     (= A 0)
     (>= L 0)
     (<= L
     ...
     (= F 3))
      ...
      (block_8_if_header_f_17_26_0 E I C D J G K H L B)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Bool) (G Int) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_8_if_header_f_17_26_0 D J B C K H L I M A)
        (and (= G M)
     (= E 10)
     (>= G 0)
     (<= G
     ...
     (not (= (<= G E) F)))
      ...
      (block_9_if_true_f_16_26_0 D J B C K H L I M A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Bool) (G Int) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (not (= (<= G E) F)))
      ...
      (block_10_f_24_26_0 D J B C K H L I M A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H Int) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) ) 
    (=>
      (and
        (block_9_if_true_f_16_26_0 E K C D L I M J N A)
        (and (= B H)
     (= G 5)
     (= F A)
     (>= H 0)
     ...
     (= H G))
      ...
      (block_10_f_24_26_0 E K C D L I M J N B)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Bool) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) ) 
    (=>
      (and
        (block_10_f_24_26_0 D K B C L I M J N A)
        (and (= E 1)
     (= G 3)
     (= F A)
     (>= F 0)
     ...
     (= H (= F G)))
      ...
      (block_11_function_f__25_26_0 E K B C L I M J N A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      (and
        (block_11_function_f__25_26_0 D G B C H E I F J A)
        true
      )
      (summary_3_function_f__25_26_0 D G B C H E I F J)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      (and
        (block_7_return_function_f__25_26_0 D G B C H E I F J A)
        true
      )
      (summary_3_function_f__25_26_0 D G B C H E I F J)
    )
  ...
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Bool) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) ) 
    (=>
     ...
     (= H (= F G)))
      ...
      (block_7_return_function_f__25_26_0 E K B C L I M J N A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E state_type) (F state_type) (G Int) (H tx_type) (I Int) (J Int) ) 
    (=>
      ...
      (block_12_function_f__25_26_0 D G B C H E I F J A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G state_type) (H state_type) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (block_12_function_f__25_26_0 D K B C L G M H N A)
        (summary_3_function_f__25_26_0 E K B C L I N J O)
  ...
  (and (= I (state_type a!1))
      ...
      (summary_4_function_f__25_26_0 E K B C L G M J O)
    )
  )
)
(assert
