...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D |struct C.S|) (E Int) (F |struct C.S|) (G |struct C.S|) (H |struct C.S|) (I |struct C.S|) (J |struct C.S|) (K state_type) (L state_type) (M Int) (N tx_type) ) 
    (=>
      (and
        (block_18_conditional_increment_50_52_0 C M A B N K H L I)
        (and (= J G) (= G F) (= E 1) (= E (|struct C.S_accessor_x| F)) (= D I))
      )
      (block_15_return_function_conditional_increment__51_52_0 C M A B N K H L J)
    )
  )
)
(assert
