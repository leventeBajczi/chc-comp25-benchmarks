...
(declare-fun |block_11_function_f__24_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
...
(declare-fun |block_12_function_f__24_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
(declare-fun |error_target_3_0| ( ) Bool)
(declare-fun |block_9_if_true_f_15_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
(declare-fun |block_6_f_23_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
(declare-fun |block_10_f_23_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
(declare-fun |contract_initializer_13_C_25_0| ( Int Int abi_type crypto_type tx_type state_type state_type ) Bool)
(declare-fun |block_8_if_header_f_16_25_0| ( Int Int abi_type crypto_type tx_type state_type Int state_type Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G state_type) (H state_type) (I Int) (J tx_type) (K Int) (L Int) ) 
    (=>
      (and
        (block_6_f_23_25_0 E I C D J G K H L A)
        (and (= B F)
     (= A 0)
     (>= L 0)
     (<= L
     ...
     (= F 3))
      ...
      (block_8_if_header_f_16_25_0 E I C D J G K H L B)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Bool) (G Int) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_8_if_header_f_16_25_0 D J B C K H L I M A)
        (and (= G M)
     (= E 10)
     (>= G 0)
     (<= G
     ...
     (not (= (<= G E) F)))
      ...
      (block_9_if_true_f_15_25_0 D J B C K H L I M A)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Bool) (G Int) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
     ...
     (not (= (<= G E) F)))
      ...
      (block_10_f_23_25_0 D J B C K H L I M A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C abi_type) (D crypto_type) (E Int) (F Int) (G Int) (H state_type) (I state_type) (J Int) (K tx_type) (L Int) (M Int) ) 
    (=>
      (and
        (block_9_if_true_f_15_25_0 E J C D K H L I M A)
        (and (= B (+ 1 F))
     (= F A)
     (>= G 0)
     (>= F 0)
     ...
     (= G (+ 1 F)))
      ...
      (block_10_f_23_25_0 E J C D K H L I M B)
    )
  )
)
(assert
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Bool) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) ) 
    (=>
      (and
        (block_10_f_23_25_0 D K B C L I M J N A)
        (and (= E 1)
     (= G 3)
     (= F A)
     (>= F 0)
     ...
     (= H (= F G)))
      ...
      (block_11_function_f__24_25_0 E K B C L I M J N A)
    )
  )
)
(assert
  ...
  (forall ( (A Int) (B abi_type) (C crypto_type) (D Int) (E Int) (F Int) (G Int) (H Bool) (I state_type) (J state_type) (K Int) (L tx_type) (M Int) (N Int) ) 
    (=>
     ...
     (= H (= F G)))
      ...
      (block_7_return_function_f__24_25_0 E K B C L I M J N A)
    )
  )
)
(assert
