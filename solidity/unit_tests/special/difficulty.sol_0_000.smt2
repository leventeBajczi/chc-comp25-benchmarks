...
(assert
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J state_type) (K state_type) (L Int) (M tx_type) ) 
    (=>
      (and
        (block_6_f_12_14_0 E L A B M J C K D)
        (and (= H D)
     (= G (block.difficulty M))
     (= F 1)
     (>= D 0)
     (>= H 0)
     (>= G 0)
     ...
     (= I (= G H)))
      ...
      (block_8_function_f__13_14_0 F L A B M J C K D)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J state_type) (K state_type) (L Int) (M tx_type) ) 
    (=>
     ...
     (= I (= G H)))
      ...
      (block_7_return_function_f__13_14_0 F L A B M J C K D)
    )
  )
)
(assert
  ...
  (forall ( (A abi_type) (B crypto_type) (C Int) (D Int) (E Int) (F state_type) (G state_type) (H Int) (I tx_type) ) 
    (=>
      (and
        ...
        (interface_0_C_14_0 H A B F)
        (= E 0)
      )
      (interface_0_C_14_0 H A B G)
    )
  )
)
(assert
