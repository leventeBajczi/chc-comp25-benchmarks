...
(declare-fun |interface_0_C_24_0| ( Int (Array Int (Array Int (Array Int (Array Int Int)))) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) (Array Int Int) Int ) Bool)
...
(assert
  ...
  B)
      ...
      (block_6_f_22_24_0 I L C D E F M N O P Q R S T U V W X Y Z A1 J G A K H B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C (Array Int (Array Int (Array Int (Array Int Int))))) (D (Array (Array Int Int) (Array Int Int))) (E (Array (Array Int Int) (Array Int Int))) (F (Array (Array Int Int) (Array Int Int))) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Bool) (R (Array Int Int)) (S (Array Int Int)) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 (Array Int Int)) (C1 (Array Int Int)) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) ) 
    (=>
      (and
        (block_6_f_22_24_0
  J
...
(assert
  ...
  H
  B)
        (interface_0_C_24_0 L C D E F J G)
        (= I 0)
      )
      (interface_0_C_24_0 L C D E F K H)
    )
  )
)
(assert
  (forall ( (A (Array Int (Array Int (Array Int (Array Int Int))))) (B (Array (Array Int Int) (Array Int Int))) (C (Array (Array Int Int) (Array Int Int))) (D (Array (Array Int Int) (Array Int Int))) (E Int) (F Int) (G Int) (H (Array Int Int)) (I (Array Int Int)) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R (Array Int Int)) (S (Array Int Int)) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) ) 
    (=>
      (and
        (summary_constructor_2_C_24_0 G J A B C D K L M N O P Q R S T U V W X Y H I E F)
        (and (= G 0)
     (>= Y 0)
     (>= X 0)
     (>= W 0)
     ...
     (= W 0))
      ...
      (interface_0_C_24_0 J A B C D I F)
    )
  )
)
(assert
...
(assert
  ...
  F)
      ...
      (contract_initializer_10_C_24_0
  G
  J
  A
  B
