...
(declare-fun |interface_0_C_25_0| ( Int (Array Int (Array Int (Array Int (Array Int Int)))) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) (Array Int Int) (Array Int Int) Int ) Bool)
...
(assert
  ...
  C1)
      ...
      (block_6_f_23_25_0 E L A B C D M N O P Q R S T U V W X Y Z A1 J F G B1 K H I C1)
    )
  )
)
(assert
...
(assert
  ...
  I
  C1)
        (interface_0_C_25_0 L A B C D J F G)
        (= E 0)
      )
      (interface_0_C_25_0 L A B C D K H I)
    )
  )
)
(assert
...
(assert
  ...
  I)
      ...
      (contract_initializer_10_C_25_0
  E
  L
  A
  B
