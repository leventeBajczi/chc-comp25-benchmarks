...
(assert
  ...
  Z)
      ...
      (block_6_f_22_24_0 E H A B C D I J K L M N O P Q R S T U V W F X G Y Z)
    )
  )
)
(assert
  (forall ( (A (Array Int (Array Int (Array Int (Array Int Int))))) (B (Array (Array Int Int) (Array Int Int))) (C (Array (Array Int Int) (Array Int Int))) (D (Array (Array Int Int) (Array Int Int))) (E Int) (F Int) (G Bool) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N (Array Int Int)) (O (Array Int Int)) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X (Array Int Int)) (Y (Array Int Int)) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Bool) (G1 Bool) (H1 Bool) (I1 Bool) ) 
    (=>
      (and
        (block_6_f_22_24_0 E P A B C D Q R S T U V W X Y Z A1 B1 C1 D1 E1 N F1 O G1 H1)
        (and (= L (or J K))
     (= K I1)
     (= J G1)
     (= I H)
