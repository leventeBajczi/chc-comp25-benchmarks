...
(declare-fun |block_8_if_header_f_17_26_0| ( Int Int (Array Int (Array Int (Array Int (Array Int Int)))) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) Int Int Int Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int ) Bool)
...
(declare-fun |block_9_if_true_f_16_26_0| ( Int Int (Array Int (Array Int (Array Int (Array Int Int)))) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) (Array (Array Int Int) (Array Int Int)) Int Int Int Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int ) Bool)
...
(assert
  ...
  A)
      ...
      (block_6_f_24_26_0 F I B C D E J K L M N O P Q R S T U V W X G Y H Z A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C (Array Int (Array Int (Array Int (Array Int Int))))) (D (Array (Array Int Int) (Array Int Int))) (E (Array (Array Int Int) (Array Int Int))) (F (Array (Array Int Int) (Array Int Int))) (G Int) (H Int) (I (Array Int Int)) (J (Array Int Int)) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S (Array Int Int)) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) ) 
    (=>
      (and
        (block_6_f_24_26_0 G K C D E F L M N O P Q R S T U V W X Y Z I A1 J B1 A)
        (and (= B H)
     (= A 0)
     (>= B1 0)
     (<= B1
...
(assert
  ...
  A)
     ...
     (not (= (<= I G) H)))
      ...
      (block_10_f_24_26_0 F L B C D E M N O P Q R S T U V W X Y Z A1 J B1 K C1 A)
    )
  )
)
(assert
  ...
  A)
     ...
     (= J I))
      ...
      (block_10_f_24_26_0 G M C D E F N O P Q R S T U V W X Y Z A1 B1 K C1 L D1 B)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int (Array Int (Array Int (Array Int Int))))) (C (Array (Array Int Int) (Array Int Int))) (D (Array (Array Int Int) (Array Int Int))) (E (Array (Array Int Int) (Array Int Int))) (F Int) (G Int) (H Int) (I Int) (J Bool) (K (Array Int Int)) (L (Array Int Int)) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U (Array Int Int)) (V (Array Int Int)) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) ) 
    (=>
      (and
        (block_10_f_24_26_0 F M B C D E N O P Q R S T U V W X Y Z A1 B1 K C1 L D1 A)
        (and (= G 1)
     (= H A)
     (= I 3)
     (>= H 0)
