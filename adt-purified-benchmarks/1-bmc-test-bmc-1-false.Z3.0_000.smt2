...
(let ((a!2 (S_0 (S_0 (S_0 (S_0 a!1))))))
  (and (= v_4 true) (= v_5 (S_0 (S_0 a!2))) (= v_6 false))))
      )
      (main_10 A B v_6 C)
    )
  )
  ...
  (forall ( (A Nat_0) (B Nat_0) (C Bool) (D Bool) (v_4 Bool) (v_5 Nat_0) (v_6 Bool) ) 
    (=>
      (and
        ...
        (let ((a!1 (S_0 (S_0 (S_0 (S_0 Z_0))))))
(let ((a!2 (S_0 (S_0 (S_0 (S_0 a!1))))))
  (and (= v_4 false) (= v_5 (S_0 (S_0 a!2))) (= v_6 false))))
      )
      (main_10 A B v_6 C)
    )
  )
  ...
  (forall ( (A Nat_0) (B Nat_0) (C Bool) (D Bool) (E Nat_0) (v_5 Nat_0) (v_6 Nat_0) (v_7 Bool) (v_8 Bool) ) 
    (=>
      (and
        ...
        (let ((a!1 (S_0 (S_0 (S_0 (S_0 Z_0))))))
(let ((a!2 (S_0 (S_0 (S_0 (S_0 a!1))))))
  (and (= v_5 (S_0 Z_0)) (= v_6 (S_0 (S_0 a!2))) (= v_7 true) (= v_8 true))))
      )
      (main_10 A B v_8 C)
    )
  )
  ...
  (forall ( (A Nat_0) (B Nat_0) (C Bool) (D Bool) (E Nat_0) (v_5 Nat_0) (v_6 Nat_0) (v_7 Bool) (v_8 Bool) ) 
    (=>
      (and
        ...
        (let ((a!1 (S_0 (S_0 (S_0 (S_0 Z_0))))))
(let ((a!2 (S_0 (S_0 (S_0 (S_0 a!1))))))
  (and (= v_5 (S_0 Z_0)) (= v_6 (S_0 (S_0 a!2))) (= v_7 false) (= v_8 true))))
      )
      (main_10 A B v_8 C)
    )
  )
