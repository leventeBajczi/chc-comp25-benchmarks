...
(assert
  (forall ( (A Bool) (B Int) (C Bool) (D Int) (E Int) (F Int) (G Bool) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Bool) (N Int) (O Int) (P Bool) ) 
    (=>
      (and
        (let ((a!1 (= J (or (not (= E 1000)) (= F 600))))
      (a!2 (or (and G (not (<= 1000 D))) (= E D)))
      (a!4 (or (and G (not (<= 600 B))) (= F B))))
(let ((a!3 (and a!2 (or (not G) (<= 1000 D) (= E (+ 1 D)))))
      (a!5 (and a!4 (or (not G) (<= 600 B) (= F (+ 1 B))))))
  (and (= C A)
       a!1
       (= N F)
       (= O E)
