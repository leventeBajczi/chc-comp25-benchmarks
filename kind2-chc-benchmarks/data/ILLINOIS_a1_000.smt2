...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L Int) (M Bool) (N Int) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Bool) (W Bool) (X Int) (Y Bool) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) (M1 Bool) (N1 Bool) (O1 Bool) ) 
    (=>
      (and
        (excludes9_fun O P Q R S T U V W A)
        (Sofar_step A M B C N1 O1)
        (illinois_step O P Q R S T U V W X D N L E F G H I J K H1 I1 J1 K1 L1 M1)
        (let ((a!1 (and (or (not M) (not (<= 2 N))) (or (not M) (>= L 0)))))
  (and (= G A1)
       (= H B1)
       (= I C1)
       (= J D1)
