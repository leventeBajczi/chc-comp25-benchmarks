...
(let ((a!3 (and (or E (and (= O T) (= M V) (= L R))) a!2))
      ...
      (a!22 (and (or E (and (= P S) (= N U))) (or (not E) a!21))))
(let ((a!15 (or H
                (and a!5
                     (or (not J) a!6)
                     (or I (and a!8 a!9))
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Bool) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Bool) (R Bool) (S Bool) (T Int) (U Bool) (V Bool) (W Bool) (X Bool) (Y Bool) (Z Int) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Bool) (J1 Int) (K1 Bool) (L1 Bool) (M1 Bool) (N1 Int) (O1 Int) (P1 Int) (Q1 Int) (R1 Int) (S1 Bool) ) 
    (=>
      (and
        (moesi_step T U V W X L M N O P R A B C D E F N1 O1 P1 Q1 R1 S1)
        (excludes4_fun U V W X G)
        (Sofar_step G Q H I L1 M1)
        (let ((a!1 (= Y (or (not Q) (and S (not R)))))
      (a!2 (or K (= S (= (+ L M N O P) Z)))))
  (and (= B E1)
       (= C F1)
       (= D G1)
       (= E H1)
