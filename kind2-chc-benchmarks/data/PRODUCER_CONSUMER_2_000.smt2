...
(declare-fun |top_step| ( Bool Bool Bool Int Bool Int Int Int Int Int Bool Int Bool Bool Bool Bool Int Int Int Int Int Bool Int Bool Bool Bool Bool ) Bool)
...
(declare-fun |top_reset| ( Int Int Int Int Int Bool Int Bool Bool Bool Bool Int Int Int Int Int Bool Int Bool Bool Bool Bool ) Bool)
(declare-fun |MAIN| ( Int Int Int Int Int Bool Int Bool Bool Bool Bool Bool ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Bool) (G Int) (H Bool) (I Bool) (J Bool) (K Bool) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Bool) (R Int) (S Bool) (T Bool) (U Bool) (V Bool) ) 
    (=>
      (and
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Int) (G Bool) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Bool) (R Bool) (S Bool) (T Int) (U Int) (V Bool) (W Bool) (X Bool) (Y Int) (Z Bool) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Bool) (G1 Int) (H1 Bool) (I1 Bool) (J1 Bool) (K1 Bool) (L1 Int) (M1 Int) (N1 Int) (O1 Int) (P1 Int) (Q1 Bool) (R1 Int) (S1 Bool) (T1 Bool) (U1 Bool) (V1 Bool) ) 
    (=>
      (and
        (Sofar_step A R B C U1 V1)
        (First_step Y T F G R1 S1)
        (PRODUCER_CONSUMMER_step V W X Y U H I J K L M N O P Q L1 M1 N1 O1 P1 Q1)
        (and (= B J1)
     (= C K1)
     (= D I1)
     (= E D)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Bool) (G Int) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Bool) (V Int) (W Bool) (X Bool) (Y Bool) (Z Bool) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Bool) (G1 Int) (H1 Bool) (I1 Bool) (J1 Bool) (K1 Bool) (L1 Bool) ) 
    (=>
      (and
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L Int) (M Bool) (N Bool) (O Bool) (P Bool) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Bool) (W Int) (X Bool) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) ) 
    (=>
      (and
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Bool) (G Int) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) ) 
    (=>
      (and
