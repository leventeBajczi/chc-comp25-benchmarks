...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Bool) (T Int) (U Int) (V Int) (W Int) (X Bool) ) 
    (=>
      ...
      (a!8 (or (not E) (and (= N (+ (- 1) O)) (= M (+ P Q R)) (= L 0) (= K 0)))))
...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Bool) (I Bool) (J Bool) (K Bool) (L Int) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Int) (W Int) (X Int) (Y Int) (Z Bool) (A1 Bool) (B1 Bool) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Bool) ) 
    (=>
      (and
        (mesi_step O P Q R M L N B C D E F G C1 D1 E1 F1 G1)
        (excludes4_fun O P Q R H)
        (Sofar_step A K I J A1 B1)
        (let ((a!1 (or (not K) (and (or (<= N 1) (<= M 1)) (<= M 2) (>= L 0)))))
  (and (= D W)
       (= E X)
       (= F Y)
       (= J U)
