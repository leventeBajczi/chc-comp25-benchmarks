...
(declare-fun |top_step| ( Bool Bool Bool Bool Bool Bool Bool Bool Bool Int Bool Int Int Bool Bool Int Int Int Int Int Bool Bool Bool Int Int Bool Bool Int Int Int Int Int Bool Bool Bool ) Bool)
...
(declare-fun |MAIN| ( Int Int Bool Bool Int Int Int Int Int Bool Bool Bool Bool ) Bool)
(declare-fun |top_reset| ( Int Int Bool Bool Int Int Int Int Int Bool Bool Bool Int Int Bool Bool Int Int Int Int Int Bool Bool Bool ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Bool) (M Int) (N Int) (O Bool) (P Bool) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Bool) (W Bool) (X Bool) ) 
    (=>
      (and
        (First_reset B C N O)
        (Sofar_reset K L W X)
        (illinois_reset E F G H I J Q R S T U V)
        (and (= P true) (= M A))
      )
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Bool) (M Int) (N Bool) (O Bool) (P Bool) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Bool) (W Bool) (X Bool) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Int) (F1 Bool) (G1 Int) (H1 Int) (I1 Bool) (J1 Bool) (K1 Int) (L1 Int) (M1 Int) (N1 Int) (O1 Int) (P1 Bool) (Q1 Bool) (R1 Bool) (S1 Int) (T1 Int) (U1 Bool) (V1 Bool) (W1 Int) (X1 Int) (Y1 Int) (Z1 Int) (A2 Int) (B2 Bool) (C2 Bool) (D2 Bool) ) 
    (=>
      (and
        (excludes9_fun V W X Y Z A1 B1 C1 D1 B)
        (Sofar_step A O C D C2 D2)
        (illinois_step V W X Y Z A1 B1 C1 D1 E1 Q R U S E F G H I J W1 X1 Y1 Z1 A2 B2)
        (First_step E1 T M N T1 U1)
        (let ((a!1 (= A (and B (not (<= E1 0)))))
      (a!2 (or L (= P (= (+ Q R U S) G1))))
      (a!3 (or (not O) (and P (not (<= 2 U)) (>= U 0) (= (+ Q R U S) T)))))
  (and (= C Q1)
       (= D R1)
       (= J P1)
       (= K J1)
...
(assert
  (forall ( (A Int) (B Int) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Int) (W Int) (X Int) (Y Bool) (Z Bool) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Bool) (G1 Bool) (H1 Bool) (I1 Int) (J1 Int) (K1 Bool) (L1 Bool) (M1 Int) (N1 Int) (O1 Int) (P1 Int) (Q1 Int) (R1 Bool) (S1 Bool) (T1 Bool) (U1 Bool) ) 
    (=>
      (and
        (top_step M
          N
          ...
          T1)
        INIT_STATE
        (top_reset A B C D E F G H I J K L W X Y Z A1 B1 C1 D1 E1 F1 G1 H1)
        true
      )
      (MAIN I1 J1 K1 L1 M1 N1 O1 P1 Q1 R1 S1 T1 U1)
    )
  )
)
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Bool) (O Bool) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Bool) (V Bool) (W Bool) (X Int) (Y Int) (Z Bool) (A1 Bool) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Bool) (H1 Bool) (I1 Bool) (J1 Bool) ) 
    (=>
      (and
        (top_step B
          C
          ...
          H1
          I1)
        (MAIN L M N O P Q R S T U V W A)
        true
      )
...
(assert
  (forall ( (A Int) (B Int) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Bool) (M Bool) ) 
    (=>
      (and
