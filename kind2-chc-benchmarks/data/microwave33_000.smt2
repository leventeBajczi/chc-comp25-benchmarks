...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q Bool) (R Int) (S Int) (T Bool) (U Int) (V Int) (W Bool) (X Int) (Y Int) (Z Int) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Int) (F1 Bool) (G1 Int) (H1 Bool) (I1 Int) (J1 Int) (K1 Bool) (L1 Int) (M1 Int) (N1 Int) (O1 Bool) (P1 Int) (Q1 Bool) (R1 Bool) (S1 Bool) (T1 Bool) (U1 Int) (V1 Bool) (W1 Bool) (X1 Int) (Y1 Int) (Z1 Bool) (A2 Bool) (B2 Bool) (C2 Int) (D2 Bool) (E2 Int) (F2 Bool) (G2 Bool) (H2 Int) (I2 Int) (J2 Int) (K2 Int) (L2 Int) (M2 Int) (N2 Int) (O2 Bool) (P2 Int) (Q2 Bool) (R2 Int) (S2 Bool) (T2 Bool) (U2 Int) (V2 Int) (W2 Int) (X2 Bool) (Y2 Bool) (Z2 Bool) (A3 Bool) (B3 Bool) (C3 Bool) (D3 Bool) (E3 Int) (F3 Bool) (G3 Bool) (H3 Int) (I3 Bool) (J3 Int) (K3 Int) (L3 Int) (M3 Int) (N3 Int) (O3 Int) (P3 Int) (Q3 Bool) (R3 Int) (S3 Int) (T3 Bool) (U3 Int) (V3 Int) (W3 Int) (X3 Int) (Y3 Int) (Z3 Int) (A4 Bool) (B4 Bool) (C4 Int) (D4 Bool) (E4 Bool) (F4 Bool) (G4 Bool) (H4 Bool) (I4 Bool) (J4 Bool) (K4 Bool) (L4 Bool) (M4 Bool) (N4 Bool) (O4 Bool) (P4 Bool) (Q4 Bool) (R4 Int) (S4 Bool) (T4 Bool) (U4 Int) (V4 Bool) (W4 Bool) (X4 Bool) (Y4 Bool) (Z4 Bool) (A5 Bool) (B5 Bool) (C5 Bool) (D5 Bool) (E5 Bool) (F5 Bool) (G5 Bool) (H5 Bool) (I5 Int) (J5 Int) (K5 Int) (L5 Int) (M5 Bool) (N5 Bool) (O5 Bool) (P5 Int) (Q5 Int) (R5 Int) (S5 Bool) (T5 Bool) (U5 Bool) (V5 Bool) (W5 Int) (X5 Int) (Y5 Int) (Z5 Int) (A6 Int) (B6 Bool) (C6 Bool) (D6 Bool) (E6 Bool) (F6 Int) (G6 Bool) (H6 Int) (I6 Bool) (J6 Bool) (K6 Int) (L6 Bool) (M6 Bool) (N6 Bool) (O6 Bool) (P6 Bool) (Q6 Bool) (R6 Bool) (S6 Bool) (T6 Bool) (U6 Bool) (V6 Bool) (W6 Bool) (X6 Bool) (Y6 Int) (Z6 Int) (A7 Int) (B7 Int) (C7 Bool) (D7 Bool) (E7 Bool) (F7 Int) (G7 Int) (H7 Int) (I7 Bool) (J7 Bool) (K7 Bool) (L7 Bool) (M7 Int) (N7 Int) (O7 Int) (P7 Int) (Q7 Int) (R7 Bool) (S7 Bool) (T7 Bool) (U7 Bool) (V7 Int) (W7 Bool) ) 
    (=>
      (and
        (let ((a!1 (and (or (not (<= Z 3)) (not (>= Z 1))) (<= V 3) (>= V 1)))
      (a!2 (= T2 (and (not B2) (not (<= U2 0)) (= P1 2))))
      (a!3 (= G3 (and (not T2) (not B2) (or (not A2) Z1) (= C2 2))))
      (a!4 (div (+ S3 (* (- 60) (div S3 60))) 10))
      ...
      (a!18 (and (or (and (<= J3 3) (>= J3 1)) (= G1 J3))
                 (or (not (<= J3 3)) (not (>= J3 1)) (= G1 0))))
      ...
      (a!27 (and (or (= K3 4) (= Z K3)) (or (not (= K3 4)) (= Z 0))))
      ...
      (a!33 (and (or (= H3 C2) (= C2 2)) (or (not (= C2 2)) (= H3 1))))
      (a!34 (or (not Q3) (and (or (= C4 J2) G2) (or (not G2) (= C4 1)))))
      (a!35 (or (not G3) (and (or F3 (= C4 H2)) (or (not F3) (= C4 3)))))
      (a!38 (and (or (= S3 U2) T2) (or (not T2) (= S3 (+ (- 1) U2)))))
      (a!40 (or (not G3) (and (or (= R3 H3) F3) (or (not F3) (= R3 3)))))
      (a!43 (or (= K1 (and (not E6) E4)) T3))
      (a!44 (= Q4
               (or M5
                   (not I4)
                   (and (not V4) F4)
      ...
      (a!51 (= X2
               (or (and (not V4) F4)
                   ...
                   (= U3 A6)
                   (not B4))))
      (a!52 (or (and (or (not O4) (= Y3 9)) (or O4 (= Y3 10))) N4))
      (a!64 (and (= Y3 I5) (= X3 J5) (= W3 K5)))
      (a!65 (or (and (or (not O) (= Y3 9)) (or (= Y3 10) O)) N))
      (a!78 (= Z3 (+ Y3 (* 10 X3) (* 60 W3))))
      (a!82 (and (or (<= L2 0) (= P3 L2)) (or (not (<= L2 0)) (= P3 0))))
      (a!84 (and (or (<= N2 0) (= N3 N2)) (or (not (<= N2 0)) (= N3 0))))
      (a!86 (and (or (<= M2 0) (= O3 M2)) (or (not (<= M2 0)) (= O3 0))))
      (a!88 (and (or (<= P2 0) (= M3 P2)) (or (not (<= P2 0)) (= M3 0))))
      (a!90 (and (or (<= K2 0) (= V3 K2)) (or (not (<= K2 0)) (= V3 0))))
      (a!92 (and (or (<= R2 0) (= L3 R2)) (or (not (<= R2 0)) (= L3 0))))
      (a!94 (or (not B4) (and (or (not S4) (not A4)) (or S4 (= A4 T4)))))
      (a!95 (or (and (or (not S5) (not Q3)) (or S5 (= Q3 T5))) T3))
      (a!96 (or (and (or (not O4) (= D 9)) (or O4 (= D 10))) N4)))
(let ((a!5 (= U3 (+ S3 (* (- 60) (div S3 60)) (* (- 10) a!4))))
      (a!7 (or (and a!6 (or (not N) (= C 8))) M))
      (a!29 (or (not F2) (and a!28 (or (= I2 E1) D1))))
      (a!36 (or (not I3) (and a!35 (or G3 (= C4 H2)))))
      (a!39 (or (and (or (not I3) a!38) (or I3 (= S3 V2))) Q3))
      (a!41 (or (not I3) (and a!40 (or (= R3 H3) G3))))
      (a!53 (or (and a!52 (or (not N4) (= Y3 8))) M4))
      (a!66 (or (and a!65 (or (not N) (= Y3 8))) M))
      (a!79 (and (or (and (not B4) A4) a!78) (or (not A4) B4 (= Z3 0))))
      (a!80 (or (and (not B4) A4) (and (or B4 (= Z3 U4)) (or (not B4) a!78))))
      (a!83 (or (and (or a!82 O2) (or (not O2) (= P3 639))) T3))
      (a!85 (or (and (or (not O2) a!84) (or (= N3 639) O2)) T3))
      (a!87 (or (and (or (not Q2) a!86) (or Q2 (= O3 639))) T3))
      (a!89 (or (and (or a!88 Q2) (or (not Q2) (= M3 639))) T3))
      (a!91 (or (and (or (not S2) a!90) (or S2 (= V3 639))) T3))
      (a!93 (or (and (or a!92 S2) (or (not S2) (= L3 639))) T3))
      (a!97 (or (and a!96 (or (not N4) (= D 8))) M4)))
(let ((a!8 (or (and a!7 (or (not M) (= C 7))) L))
      (a!37 (or (and a!36 (or I3 (= C4 I2))) Q3))
      (a!42 (or (and a!41 (or (= R3 J3) I3)) Q3))
      (a!54 (or (and a!53 (or (not M4) (= Y3 7))) L4))
      (a!67 (or (and a!66 (or (not M) (= Y3 7))) L))
      (a!81 (or (and a!80 (or (not A4) B4 (= Z3 0))) T3))
      (a!98 (or (and a!97 (or (not M4) (= D 7))) L4)))
(let ((a!9 (or (and a!8 (or (not L) (= C 6))) K))
      (a!55 (or (and a!54 (or (not L4) (= Y3 6))) K4))
      (a!68 (or (and a!67 (or (not L) (= Y3 6))) K))
      (a!99 (or (and a!98 (or (not L4) (= D 6))) K4)))
(let ((a!10 (or (and a!9 (or (not K) (= C 5))) J))
      (a!56 (or (and a!55 (or (not K4) (= Y3 5))) J4))
      (a!69 (or (and a!68 (or (not K) (= Y3 5))) J))
      (a!100 (or (and a!99 (or (not K4) (= D 5))) J4)))
(let ((a!11 (or (and a!10 (or (not J) (= C 4))) I))
      (a!57 (or (and a!56 (or (not J4) (= Y3 4))) I4))
      (a!70 (or (and a!69 (or (not J) (= Y3 4))) I))
      (a!101 (or (and a!100 (or (not J4) (= D 4))) I4)))
(let ((a!12 (or (and a!11 (or (not I) (= C 3))) H))
      (a!58 (or (and a!57 (or (not I4) (= Y3 3))) H4))
      (a!71 (or (and a!70 (or (not I) (= Y3 3))) H))
      (a!102 (or (and a!101 (or (not I4) (= D 3))) H4)))
(let ((a!13 (or (and a!12 (or (not H) (= C 2))) G))
      (a!59 (or (and a!58 (or (not H4) (= Y3 2))) G4))
      (a!72 (or (and a!71 (or (not H) (= Y3 2))) G))
      (a!103 (or (and a!102 (or (not H4) (= D 2))) G4)))
(let ((a!14 (or (and a!13 (or (not G) (= C 1))) F))
      (a!60 (or (and a!59 (or (not G4) (= Y3 1))) F4))
      (a!73 (or (and a!72 (or (not G) (= Y3 1))) F))
      (a!104 (or (and a!103 (or (not G4) (= D 1))) F4)))
(let ((a!61 (or (not P) (and a!60 (or (not F4) (= Y3 0)))))
      (a!74 (or (not E) (and a!73 (or (not F) (= Y3 0)) (= X3 I5) (= W3 J5)))))
(let ((a!62 (or (and a!61 (or (= Y3 0) P)) E4))
      (a!75 (and (or (and (or E a!64) a!74) E4)
                 (or (not E4) (and (= Y3 0) (= X3 0) (= W3 0))))))
(let ((a!63 (or (not T3)
                (and a!62 (or (not E4) (= Y3 0)) (= X3 0) (= W3 0) (= Q D4))))
      (a!76 (or (not A4) (and a!62 (or (not E4) (= Y3 0)) (= X3 0) (= W3 0)))))
(let ((a!77 (and (or (not B4) (and (or a!75 A4) a!76))
                 (or B4 a!64)
                 (= Q (and (not V5) D4)))))
  (and (not (= (= S 0) H1))
       (not (= (= U 0) A2))
       ...
       (or (not T3) (= P3 639))
       (or (not T3) (= V3 639))
       (or (and a!45 a!46 a!47 a!48 a!49 a!50 a!51) T3)
       (or (not T3) (and D3 C3 B3 A3 Z2 Y2 X2))
       a!63
       (or a!77 T3)
       (or (not T3) a!79)
       a!81
