...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Bool) (E Bool) (F Bool) (G Bool) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Bool) (R Bool) (S Int) (T Bool) (U Bool) (V Bool) (W Bool) (X Bool) (Y Bool) (Z Bool) (A1 Bool) (B1 Int) (C1 Bool) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Bool) (K1 Bool) (L1 Bool) (M1 Int) (N1 Bool) (O1 Int) (P1 Int) (Q1 Int) (R1 Int) (S1 Int) (T1 Int) (U1 Bool) (V1 Bool) (W1 Bool) (X1 Int) (Y1 Bool) ) 
    (=>
      (and
        (First_step B1 B C D X1 Y1)
        (excludes8_fun T U V W X Y Z A1 E)
        (Sofar_step A R F G V1 W1)
        (firefly_step T U V W X Y Z A1 B1 H I J S K L M N O P Q O1 P1 Q1 R1 S1 T1 U1)
        (let ((a!1 (= A (and E (not (<= 5 B1)) (>= B1 0)))))
  (and (= C1 (or (not R) (>= S 0)))
       (= D N1)
       (= F K1)
       (= G L1)
