...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L Bool) (M Bool) (N Int) (O Bool) (P Bool) (Q Bool) (R Int) (S Int) (T Int) (U Int) (V Bool) (W Int) (X Int) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Bool) (I1 Bool) (J1 Bool) (K1 Int) (L1 Bool) (M1 Int) (N1 Int) (O1 Bool) (P1 Bool) (Q1 Int) (R1 Int) (S1 Int) (T1 Int) (U1 Int) (V1 Int) (W1 Bool) (X1 Bool) (Y1 Bool) (Z1 Int) (A2 Int) (B2 Bool) (C2 Bool) (D2 Int) (E2 Int) (F2 Int) (G2 Int) (H2 Int) (I2 Int) (J2 Bool) (K2 Bool) (L2 Bool) ) 
    (=>
      (and
        (excludes12_fun Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 B)
        (Sofar_step A V C D K2 L2)
        (DRAGON_step Y
             Z
             A1
             B1
             ...
             I2
             J2)
        (First_step K1 X N O A2 B2)
        (let ((a!1 (and (or (not V) (not P))
                (or (not V) Q)
                (or (not V) (<= W X))
                (or (not V) (<= U X))
                (or (not V) (<= U 1))
                ...
                (or (not V) (>= S 0))
                (or (not V) (>= R 0))
                (or (not V) (= (+ R S T U W) X))
                (or (not V) (not (<= 1 U)) (not (<= 1 S)))))
      (a!2 (= A (and B (not (<= K1 0)))))
      (a!3 (or M (= Q (= (+ R S T U W) M1)))))
  (and (= D Y1)
       (= K W1)
       (= L P1)
       (= M L)
