...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Bool) (H Bool) (I Bool) (J Int) (K Int) (L Int) (M Bool) (N Bool) (O Bool) (P Bool) (Q Bool) (R Bool) (S Int) (T Bool) (U Bool) (V Bool) (W Bool) (X Bool) (Y Int) (Z Int) (A1 Int) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Bool) (F1 Int) (G1 Int) (H1 Int) (I1 Bool) (J1 Bool) ) 
    (=>
      (and
        (voiture_step T U B C D S E F G H I J K L M N F1 G1 H1 I1 J1)
        (excludes2_fun T U O)
        (Sofar_step A R P Q D1 E1)
        (let ((a!1 (= A (and O (not (<= 32767 S))))))
  (and (= K Z)
       (= L A1)
       (= M B1)
       (= N C1)
