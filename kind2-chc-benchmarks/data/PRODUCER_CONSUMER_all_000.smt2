...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Int) (I Bool) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Bool) (S Bool) (T Bool) (U Int) (V Bool) (W Bool) (X Int) (Y Int) (Z Bool) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Int) (E1 Bool) (F1 Int) (G1 Bool) (H1 Bool) (I1 Int) (J1 Int) (K1 Int) (L1 Int) (M1 Int) (N1 Bool) (O1 Int) (P1 Bool) (Q1 Bool) (R1 Bool) (S1 Bool) (T1 Bool) (U1 Int) (V1 Bool) (W1 Bool) (X1 Int) (Y1 Int) (Z1 Int) (A2 Int) (B2 Int) (C2 Bool) (D2 Int) (E2 Bool) (F2 Bool) (G2 Bool) (H2 Bool) (I2 Bool) ) 
    (=>
      (and
        (excludes3_fun A1 B1 C1 C)
        (Sofar_step B V D E H2 I2)
        (FirstB_step A W F G F2 G2)
        (First_step D1 X H I D2 E2)
        (PRODUCER_CONSUMMER_step A1 B1 C1 D1 Y J K U L M N O P Q R X1 Y1 Z1 A2 B2 C2)
        (let ((a!1 (= E1 (or (<= X 0) (and Z (>= Y 0)) (not W) (not V))))
      (a!2 (= B (or C (and (not C1) (not B1) (not A1)))))
      (a!3 (= Z (or (not G1) (not B1) (= U F1) (= U (+ 1 F1))))))
  (and (= D S1)
       (= E T1)
       (= F Q1)
       (= G R1)
