...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Bool) (M Bool) (N Int) (O Bool) (P Int) (Q Bool) (R Bool) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Bool) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Bool) (I1 Bool) (J1 Int) (K1 Int) (L1 Bool) (M1 Int) (N1 Bool) (O1 Int) (P1 Bool) (Q1 Bool) (R1 Bool) (S1 Int) (T1 Int) (U1 Int) (V1 Int) (W1 Int) (X1 Int) (Y1 Int) (Z1 Int) (A2 Int) (B2 Bool) (C2 Int) (D2 Bool) (E2 Int) (F2 Bool) (G2 Bool) (H2 Bool) (I2 Int) (J2 Int) (K2 Int) (L2 Int) (M2 Int) (N2 Int) (O2 Int) (P2 Int) (Q2 Int) (R2 Bool) ) 
    (=>
      (and
        (swimingpool_step D1
                  E1
                  ...
                  Q2
                  R2)
        (excludes6_fun D1 E1 F1 G1 H1 I1 K)
        (Sofar_step K R L M G2 H2)
        (First_step J1 S N O E2 F2)
        (First_step K1 T P Q C2 D2)
        (let ((a!1 (= L1
              (or (<= 1000 T)
                  (<= 1000 S)
                  (<= (+ U V W X Y Z A1) (+ B1 C1))
                  (not R)
                  (not (<= 0 T))
                  (not (<= 0 S))))))
  (and (= J B2)
