...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) ) 
    (=>
      (and
        (not (= (or B A (and C A) (and D A) (and C B) (and D B) (and D C)) E))
      )
...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Int) (W Int) (X Int) (Y Int) (Z Bool) (A1 Bool) (B1 Bool) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Bool) ) 
    (=>
      (and
        (mesi_step O P Q R M B N C D E F G H C1 D1 E1 F1 G1)
        (excludes4_fun O P Q R I)
        (Sofar_step A L J K A1 B1)
        (and (= E W)
     (= F X)
     (= G Y)
     (= J T)
