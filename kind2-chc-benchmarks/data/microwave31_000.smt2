...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q Bool) (R Int) (S Int) (T Bool) (U Int) (V Int) (W Bool) (X Int) (Y Int) (Z Int) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Int) (F1 Bool) (G1 Int) (H1 Bool) (I1 Int) (J1 Int) (K1 Bool) (L1 Int) (M1 Int) (N1 Int) (O1 Bool) (P1 Int) (Q1 Bool) (R1 Bool) (S1 Bool) (T1 Bool) (U1 Int) (V1 Bool) (W1 Bool) (X1 Int) (Y1 Int) (Z1 Bool) (A2 Bool) (B2 Bool) (C2 Int) (D2 Bool) (E2 Int) (F2 Bool) (G2 Bool) (H2 Int) (I2 Int) (J2 Int) (K2 Int) (L2 Int) (M2 Int) (N2 Int) (O2 Bool) (P2 Int) (Q2 Bool) (R2 Int) (S2 Bool) (T2 Bool) (U2 Int) (V2 Int) (W2 Int) (X2 Bool) (Y2 Bool) (Z2 Bool) (A3 Bool) (B3 Bool) (C3 Bool) (D3 Bool) (E3 Bool) (F3 Bool) (G3 Int) (H3 Bool) (I3 Bool) (J3 Int) (K3 Bool) (L3 Int) (M3 Int) (N3 Int) (O3 Int) (P3 Int) (Q3 Int) (R3 Int) (S3 Bool) (T3 Int) (U3 Int) (V3 Int) (W3 Int) (X3 Int) (Y3 Int) (Z3 Bool) (A4 Int) (B4 Int) (C4 Bool) (D4 Bool) (E4 Int) (F4 Bool) (G4 Bool) (H4 Bool) (I4 Bool) (J4 Bool) (K4 Bool) (L4 Bool) (M4 Bool) (N4 Bool) (O4 Bool) (P4 Bool) (Q4 Bool) (R4 Bool) (S4 Bool) (T4 Int) (U4 Bool) (V4 Bool) (W4 Int) (X4 Bool) (Y4 Bool) (Z4 Bool) (A5 Bool) (B5 Bool) (C5 Bool) (D5 Bool) (E5 Bool) (F5 Bool) (G5 Bool) (H5 Bool) (I5 Bool) (J5 Bool) (K5 Int) (L5 Int) (M5 Int) (N5 Int) (O5 Bool) (P5 Bool) (Q5 Bool) (R5 Int) (S5 Int) (T5 Int) (U5 Bool) (V5 Bool) (W5 Bool) (X5 Bool) (Y5 Int) (Z5 Int) (A6 Int) (B6 Int) (C6 Int) (D6 Bool) (E6 Bool) (F6 Bool) (G6 Bool) (H6 Int) (I6 Bool) (J6 Int) (K6 Bool) (L6 Bool) (M6 Int) (N6 Bool) (O6 Bool) (P6 Bool) (Q6 Bool) (R6 Bool) (S6 Bool) (T6 Bool) (U6 Bool) (V6 Bool) (W6 Bool) (X6 Bool) (Y6 Bool) (Z6 Bool) (A7 Int) (B7 Int) (C7 Int) (D7 Int) (E7 Bool) (F7 Bool) (G7 Bool) (H7 Int) (I7 Int) (J7 Int) (K7 Bool) (L7 Bool) (M7 Bool) (N7 Bool) (O7 Int) (P7 Int) (Q7 Int) (R7 Int) (S7 Int) (T7 Bool) (U7 Bool) (V7 Bool) (W7 Bool) (X7 Int) (Y7 Bool) ) 
    (=>
      (and
        (let ((a!1 (and (or (not (<= Z 3)) (not (>= Z 1))) (<= V 3) (>= V 1)))
      (a!2 (= T2 (and (not B2) (not (<= U2 0)) (= P1 2))))
      (a!3 (= I3 (and (not T2) (not B2) (or (not A2) Z1) (= C2 2))))
      (a!4 (div (+ U3 (* (- 60) (div U3 60))) 10))
      ...
      (a!18 (and (or (and (<= L3 3) (>= L3 1)) (= G1 L3))
                 (or (not (<= L3 3)) (not (>= L3 1)) (= G1 0))))
      ...
      (a!27 (and (or (= M3 4) (= Z M3)) (or (not (= M3 4)) (= Z 0))))
      ...
      (a!33 (and (or (= J3 C2) (= C2 2)) (or (not (= C2 2)) (= J3 1))))
      (a!34 (or (not S3) (and (or (= E4 J2) G2) (or (not G2) (= E4 1)))))
      (a!35 (or (not I3) (and (or H3 (= E4 H2)) (or (not H3) (= E4 3)))))
      (a!38 (and (or (= U3 U2) T2) (or (not T2) (= U3 (+ (- 1) U2)))))
      (a!40 (or (not I3) (and (or (= T3 J3) H3) (or (not H3) (= T3 3)))))
      (a!43 (or (= K1 (and (not G6) G4)) Z3))
      (a!44 (= S4 (or D5 (not I4) (and (not X4) H4) G4 (= A4 1) (not D4))))
      (a!45 (= F3
               (or J5
                   (not J4)
                   (and (not X4) H4)
      ...
      (a!53 (= X2
               (or (and (not X4) H4)
                   ...
                   (= A4 C6)
                   (not D4))))
      (a!54 (or (and (or (not Q4) (= Y3 9)) (or Q4 (= Y3 10))) P4))
      (a!66 (and (= Y3 K5) (= X3 L5) (= W3 M5)))
      (a!67 (or (and (or (not O) (= Y3 9)) (or (= Y3 10) O)) N))
      (a!80 (= B4 (+ Y3 (* 10 X3) (* 60 W3))))
      (a!84 (and (or (<= L2 0) (= R3 L2)) (or (not (<= L2 0)) (= R3 0))))
      (a!86 (and (or (<= N2 0) (= P3 N2)) (or (not (<= N2 0)) (= P3 0))))
      (a!88 (and (or (<= M2 0) (= Q3 M2)) (or (not (<= M2 0)) (= Q3 0))))
      (a!90 (and (or (<= P2 0) (= O3 P2)) (or (not (<= P2 0)) (= O3 0))))
      (a!92 (and (or (<= K2 0) (= V3 K2)) (or (not (<= K2 0)) (= V3 0))))
      (a!94 (and (or (<= R2 0) (= N3 R2)) (or (not (<= R2 0)) (= N3 0))))
      (a!96 (or (not D4) (and (or (not U4) (not C4)) (or U4 (= C4 V4)))))
      (a!97 (or (and (or (not U5) (not S3)) (or U5 (= S3 V5))) Z3))
      (a!98 (or (and (or (not Q4) (= D 9)) (or Q4 (= D 10))) P4)))
(let ((a!5 (= A4 (+ U3 (* (- 60) (div U3 60)) (* (- 10) a!4))))
      (a!7 (or (and a!6 (or (not N) (= C 8))) M))
      (a!29 (or (not F2) (and a!28 (or (= I2 E1) D1))))
      (a!36 (or (not K3) (and a!35 (or I3 (= E4 H2)))))
      (a!39 (or (and (or (not K3) a!38) (or K3 (= U3 V2))) S3))
      (a!41 (or (not K3) (and a!40 (or (= T3 J3) I3))))
      (a!55 (or (and a!54 (or (not P4) (= Y3 8))) O4))
      (a!68 (or (and a!67 (or (not N) (= Y3 8))) M))
      (a!81 (and (or (and (not D4) C4) a!80) (or (not C4) D4 (= B4 0))))
      (a!82 (or (and (not D4) C4) (and (or D4 (= B4 W4)) (or (not D4) a!80))))
      (a!85 (or (and (or a!84 O2) (or (not O2) (= R3 639))) Z3))
      (a!87 (or (and (or (not O2) a!86) (or (= P3 639) O2)) Z3))
      (a!89 (or (and (or (not Q2) a!88) (or Q2 (= Q3 639))) Z3))
      (a!91 (or (and (or a!90 Q2) (or (not Q2) (= O3 639))) Z3))
      (a!93 (or (and (or (not S2) a!92) (or S2 (= V3 639))) Z3))
      (a!95 (or (and (or a!94 S2) (or (not S2) (= N3 639))) Z3))
      (a!99 (or (and a!98 (or (not P4) (= D 8))) O4)))
(let ((a!8 (or (and a!7 (or (not M) (= C 7))) L))
      (a!37 (or (and a!36 (or K3 (= E4 I2))) S3))
      (a!42 (or (and a!41 (or (= T3 L3) K3)) S3))
      (a!56 (or (and a!55 (or (not O4) (= Y3 7))) N4))
      (a!69 (or (and a!68 (or (not M) (= Y3 7))) L))
      (a!83 (or (and a!82 (or (not C4) D4 (= B4 0))) Z3))
      (a!100 (or (and a!99 (or (not O4) (= D 7))) N4)))
(let ((a!9 (or (and a!8 (or (not L) (= C 6))) K))
      (a!57 (or (and a!56 (or (not N4) (= Y3 6))) M4))
      (a!70 (or (and a!69 (or (not L) (= Y3 6))) K))
      (a!101 (or (and a!100 (or (not N4) (= D 6))) M4)))
(let ((a!10 (or (and a!9 (or (not K) (= C 5))) J))
      (a!58 (or (and a!57 (or (not M4) (= Y3 5))) L4))
      (a!71 (or (and a!70 (or (not K) (= Y3 5))) J))
      (a!102 (or (and a!101 (or (not M4) (= D 5))) L4)))
(let ((a!11 (or (and a!10 (or (not J) (= C 4))) I))
      (a!59 (or (and a!58 (or (not L4) (= Y3 4))) K4))
      (a!72 (or (and a!71 (or (not J) (= Y3 4))) I))
      (a!103 (or (and a!102 (or (not L4) (= D 4))) K4)))
(let ((a!12 (or (and a!11 (or (not I) (= C 3))) H))
      (a!60 (or (and a!59 (or (not K4) (= Y3 3))) J4))
      (a!73 (or (and a!72 (or (not I) (= Y3 3))) H))
      (a!104 (or (and a!103 (or (not K4) (= D 3))) J4)))
(let ((a!13 (or (and a!12 (or (not H) (= C 2))) G))
      (a!61 (or (and a!60 (or (not J4) (= Y3 2))) I4))
      (a!74 (or (and a!73 (or (not H) (= Y3 2))) G))
      (a!105 (or (and a!104 (or (not J4) (= D 2))) I4)))
(let ((a!14 (or (and a!13 (or (not G) (= C 1))) F))
      (a!62 (or (and a!61 (or (not I4) (= Y3 1))) H4))
      (a!75 (or (and a!74 (or (not G) (= Y3 1))) F))
      (a!106 (or (and a!105 (or (not I4) (= D 1))) H4)))
(let ((a!63 (or (not P) (and a!62 (or (not H4) (= Y3 0)))))
      (a!76 (or (not E) (and a!75 (or (not F) (= Y3 0)) (= X3 K5) (= W3 L5)))))
(let ((a!64 (or (and a!63 (or (= Y3 0) P)) G4))
      (a!77 (and (or (and (or E a!66) a!76) G4)
                 (or (not G4) (and (= Y3 0) (= X3 0) (= W3 0))))))
(let ((a!65 (or (not Z3)
                (and a!64 (or (not G4) (= Y3 0)) (= X3 0) (= W3 0) (= Q F4))))
      (a!78 (or (not C4) (and a!64 (or (not G4) (= Y3 0)) (= X3 0) (= W3 0)))))
(let ((a!79 (and (or (not D4) (and (or a!77 C4) a!78))
                 (or D4 a!66)
                 (= Q (and (not X5) F4)))))
  (and (not (= (= S 0) H1))
       (not (= (= U 0) A2))
       ...
       (or (not Z3) (= R3 639))
       (or (not Z3) (= V3 639))
       (or (and a!45 a!46 a!47 a!48 a!49 a!50 a!51 a!52 a!53) Z3)
       (or (not Z3) (and F3 E3 D3 C3 B3 A3 Z2 Y2 X2))
       a!65
       (or a!79 Z3)
       (or (not Z3) a!81)
       a!83
