...
(let ((a!4 (or W (and a!2 (or (not X) a!3))))
      ...
      (a!46 (or (and a!44 (or (not S) a!45)) R))
      (a!51 (and (or (not Z) a!50) (or Z (and (= J1 Y1) (= I1 Z1)))))
      (a!58 (or (and a!56 (or (not Y) a!57)) X)))
(let ((a!6 (or V (and a!4 (or (not W) a!5))))
      ...
      (a!48 (or (and a!46 (or (not R) a!47)) N))
      (a!54 (or (and (or a!51 U) (or (not U) a!53)) N))
      (a!60 (or (and a!58 (or (not X) a!59)) N)))
(let ((a!22 (or N
                (and a!6
                     (or (not V) a!7)
                     (or (not U) a!9)
    ...
    (=>
      (and
        (peterson_step I1
               ...
               B3
               C3)
        (excludes12_fun I1 J1 K1 L1 M1 N1 O1 P1 Q1 R1 S1 T1 D1)
        (Sofar_step A G1 E1 F1 M2 N2)
        (let ((a!1 (= A (and D1 (not (<= 32767 H1))))))
  (and (= P Y1)
       (= Q Z1)
       (= R A2)
       (= S B2)
