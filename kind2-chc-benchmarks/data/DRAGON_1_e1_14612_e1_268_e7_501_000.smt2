...
(declare-fun |top_reset| ( Bool Bool Int Int Int Int Int Int Bool Bool Bool Int Int Int Int Int Int Bool ) Bool)
...
(declare-fun |MAIN| ( Bool Bool Int Int Int Int Int Int Bool Bool ) Bool)
(declare-fun |Sofar_step| ( Bool Bool Bool Bool Bool Bool ) Bool)
(declare-fun |top_step| ( Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Int Bool Bool Bool Int Int Int Int Int Int Bool Bool Bool Int Int Int Int Int Int Bool ) Bool)
...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J Bool) (K Bool) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Bool) ) 
    (=>
      (and
        (Sofar_reset A B J K)
        (DRAGON_reset C D E F G H I L M N O P Q R)
        true
      )
    ...
    (=>
      (and
        (DRAGON_step S
             ...
             W1
             X1)
        (excludes12_fun S T U V W X Y Z A1 B1 C1 D1 N)
        (Sofar_step A Q O P P1 Q1)
        (let ((a!1 (= A (and N (not (<= E1 0))))))
  (and (= O G1)
       (= P H1)
       (= F1 (or (not R) (not Q)))
       a!1
...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Int) (W Bool) (X Bool) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) (M1 Int) (N1 Bool) (O1 Bool) ) 
    (=>
      (and
        (top_step J
          K
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Int) (O Bool) (P Bool) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) (W Bool) (X Bool) (Y Bool) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Bool) (G1 Bool) ) 
    (=>
      (and
        (top_step B
          C
...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J Bool) ) 
    (=>
      (and
