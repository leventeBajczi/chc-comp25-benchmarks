...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M Bool) (N Int) (O Bool) (P Bool) (Q Bool) (R Int) (S Bool) (T Int) (U Int) (V Int) (W Int) (X Bool) (Y Bool) (Z Bool) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Bool) (F1 Bool) (G1 Bool) ) 
    (=>
      (and
        (excludes3_fun O P Q B)
        (Sofar_step A M C D F1 G1)
        (synapse_step O P Q R E F N G H I J K L A1 B1 C1 D1 E1)
        (let ((a!1 (= S (or (not M) (not (<= 2 N))))))
  (and (= I U)
       (= J V)
       (= K W)
       (= L X)
