...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) ) 
    (=>
      (and
        (h1 A B C G H I)
        (and (= E #x00000000) (= D #x00000000) (= F #x00000064))
      )
      (h2 A B C D E F)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) ) 
    (=>
      (and
        (h6 A B C D E F)
        (bvsle (bvadd E (bvmul #xffffffff F)) #xffffffff)
      )
      (h7 A B C D E F)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) ) 
    (=>
      (and
        (h7 A B C G H F)
        (and (= G (bvadd #xfffffffe D)) (= H (bvadd #xffffffff E)))
      )
      (h8 A B C D E F)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) ) 
    (=>
      (and
        (h12 A B C D E F)
        (bvsle (bvadd D (bvmul #xfffffffe F)) #xffffffff)
      )
      (h13 A B C D E F)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) ) 
    (=>
      (and
        (h12 A B C D E F)
        (bvsle #x00000001 (bvadd D (bvmul #xfffffffe F)))
      )
      (h14 A B C D E F)
    )
  )
