...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 32)) (K (_ BitVec 32)) (L (_ BitVec 32)) ) 
    (=>
      (and
        (and (bvsle #x00000000 (bvadd #xfffffff7 D C))
     ...
     (bvsle #x00000000 (bvadd #xfffffffc (bvmul #xffffffff A) C))
     ...
     (bvsle #x00000000 (bvadd #xfffffffc E (bvmul #xffffffff A)))
     ...
     (bvsle #x00000000 (bvadd #xfffffffb D (bvmul #xffffffff A)))
     ...
     (bvsle #x00000000 (bvadd #xfffffffd E (bvmul #xffffffff F)))
     ...
     (bvsle #x00000000 A)
     (bvsle #x00000000 (bvadd #xfffffff7 D E)))
      )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 32)) (K (_ BitVec 32)) (L (_ BitVec 32)) ) 
    (=>
      (and
        (and (bvsle #x00000000 (bvadd #xfffffff9 D C))
     ...
     (bvsle #x00000000 (bvadd #xfffffffd (bvmul #xffffffff A) C))
     (bvsle #x00000000 (bvadd #xfffffffd (bvmul #xffffffff A) H))
