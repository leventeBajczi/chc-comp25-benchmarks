...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) ) 
    (=>
     ...
     (= (bvadd C D) (bvadd #x0000001f G))
     (= B #x00000000)
     (= C (bvadd #x00000001 F))
     (bvsle #x00000000 (bvadd #xffffffef C D)))
      )
      (REC_f_f A B C D E)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) ) 
    (=>
     ...
     (= B #x00000000)
     (= C (bvadd #x00000001 F))
     (not (bvsle #x00000000 (bvadd #xffffffef C D))))
      )
      (REC_f_f A B C D E)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) ) 
    (=>
      (and
        (REC_f_f G F H I E)
        (and (not (bvsle #x00000000 (bvadd #xfffffff0 F A)))
     (not (bvsle A #x00000000))
     (not (bvsle C #x00000000))
     (= (bvadd C D) (bvadd #x0000001f I))
     (= (bvadd F A) B)
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (v_6 (_ BitVec 32)) ) 
    (=>
     ...
     (= (bvadd E A) B)
     (= A (bvadd #x00000001 F))
     (not (bvsle #x00000000 (bvadd #xfffffff0 E A)))
     (= v_6 D))
      )
      (REC_f_f A B C D v_6)
    )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) ) 
    (=>
     ...
     (= (bvadd C A) B)
     (= A (bvadd #x00000001 D))
     (not (bvsle #x00000000 (bvadd #xfffffff0 C A))))
      )
      (REC_f_ A B)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) ) 
    (=>
     ...
     (= (bvadd A B) E)
     (= A (bvadd #x00000001 D))
     (not (bvsle #x00000000 (bvadd #xffffffef A B))))
      )
      (REC__f A B C)
    )
  )
  ...
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) ) 
    (=>
      (and
        (REC__f D E C)
        (and (not (bvsle A #x00000000))
     (= (bvadd A B) (bvadd #x0000001f E))
     (= A (bvadd #x00000001 D))
     (bvsle #x00000000 (bvadd #xffffffef A B)))
      )
      (REC__f A B C)
    )
  )
