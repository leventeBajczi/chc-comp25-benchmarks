...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) ) 
    (=>
      (and
        (let ((a!1 (or (and (not (= B #x00000000)) (not (bvsle #x00000002 C)))
               (and (not (= B C)) (bvsle #x00000002 C)))))
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) ) 
    (=>
      (and
        (and (bvsle B #x00000001) (not (= B #x00000000)) (bvsle #x00000002 B))
      )
      (P!!10 B A)
    )
  )
