...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (+ 1 F)) (= B (+ (- 1) E)) (= D 0) (= D E) (= C F) (distinct 0 1 2 E))
      )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= B (+ (- 1) E)) (= F C) (not (= E 0)) (= E D) (= D 2) (= A (+ 1 F)))
      )
      (INV_REC_f__1_PRE B A)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        ...
        (and (= A (+ 1 F)) (= B (+ (- 1) E)) (= D 0) (distinct 0 1 2 E))
      )
      (INV_REC_f__2_PRE B A)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (v_7 Int) ) 
    (=>
      (and
        ...
        (and (= B (+ (- 1) D)) (= C 0) (= A (+ 1 E)) (distinct 0 1 2 D) (= v_7 F))
      )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (v_7 Int) ) 
    (=>
      (and
        (INV_REC_f__1 B A F)
        (INV_REC_f^f_PRE C D E G)
        (and (not (= C 0)) (= E 2) (= A (+ 1 D)) (= B (+ (- 1) C)) (= v_7 G))
      )
      (INV_REC_f^f C D E G F v_7)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        ...
        (and (= B (+ (- 1) C)) (= A (+ 1 D)) (distinct 0 1 2 C))
      )
      (INV_REC_f__2_PRE B A)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) ) 
    (=>
      (and
        (INV_REC_f__2 B A E)
        (INV_REC_f__2_PRE C D)
        (and (= A (+ 1 D)) (= B (+ (- 1) C)) (distinct 0 1 2 C))
      )
      (INV_REC_f__2 C D E)
    )
  )
