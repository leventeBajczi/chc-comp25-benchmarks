...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__2 A D)
        (let ((a!1 (not (= B (ite (>= D 0) (+ C D) D)))))
  (and a!1 (= B C) (<= B 1) (not (<= C 1)) (= A (+ (- 1) C))))
      )
      END_QUERY
    )
  )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (and (= B (+ (- 1) C)) (= C D) (not (<= D 1)) (not (<= C 1)) (= A (+ (- 1) D)))
      )
      (INV_REC_f^f_PRE B A)
    )
  )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f^f_PRE C D)
        (and (= B (+ (- 1) C)) (not (<= D 1)) (not (<= C 1)) (= A (+ (- 1) D)))
      )
      (INV_REC_f^f_PRE B A)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__2 A D)
        (INV_REC_f__2_PRE C)
        (and (= B (ite (>= D 0) (+ C D) D)) (not (<= C 1)) (= A (+ (- 1) C)))
      )
      (INV_REC_f__2 C B)
    )
  )
