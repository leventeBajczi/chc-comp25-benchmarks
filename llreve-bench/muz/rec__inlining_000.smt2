...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (INV_REC_f^f B A E F)
        (let ((a!1 (not (= (ite (<= (- 1) E) (+ 1 E) 0) (ite (<= (- 2) F) (+ 2 F) 0)))))
  (and (= B (+ (- 1) C))
       (= A (+ (- 2) D))
       (= C D)
       (not (<= C 0))
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__1 A C)
        (let ((a!1 (not (= (ite (<= (- 1) C) (+ 1 C) 0) (ite (<= 0 D) D 0)))))
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__2 A D)
        (let ((a!1 (not (= (ite (<= 0 C) C 0) (ite (<= (- 2) D) (+ 2 D) 0)))))
...
(assert
  (forall ( (A Int) (B Int) ) 
    (=>
      (and
        (let ((a!1 (not (= (ite (<= 0 A) A 0) (ite (<= 0 B) B 0)))))
  (and (= A B) (<= B 1) (<= A 0) a!1))
      )
      END_QUERY
    )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f^f_PRE C D)
        (and (= B (ite (<= 0 C) C 0)) (<= D 1) (<= C 0) (= A (ite (<= 0 D) D 0)))
      )
      (INV_REC_f^f C D B A)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__2 A D)
        (INV_REC_f__2_PRE C)
        (and (= B (ite (<= (- 2) D) (+ 2 D) 0)) (not (<= C 1)) (= A (+ (- 2) C)))
      )
      (INV_REC_f__2 C B)
    )
  )
