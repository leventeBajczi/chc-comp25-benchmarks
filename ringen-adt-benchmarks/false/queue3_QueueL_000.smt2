...
(declare-datatypes ((Nat_0 0) (Q_0 0) (list_0 0)) (((Z_13 ) (Z_14  (unS_0 Nat_0)))
  ...
  (forall ( (A list_0) (B list_0) (C Nat_0) (D list_0) (E Nat_0) (F list_0) (G Nat_0) (v_7 Nat_0) (v_8 Nat_0) ) 
    (=>
      (and
        ...
        (gt_0 G v_8)
        (take_0 D C F)
        (and (= v_7 (Z_14 Z_13)) (= v_8 Z_13) (= A (cons_0 E F)) (= B (cons_0 E D)))
      )
      (take_0 B G A)
    )
  )
...
(assert
  (forall ( (A Nat_0) (v_1 Nat_0) (v_2 list_0) (v_3 list_0) ) 
    (=>
      (and
        (gt_0 A v_1)
        (and (= v_1 Z_13) (= v_2 nil_0) (= v_3 nil_0))
      )
      (take_0 v_2 A v_3)
    )
  )
  ...
  (forall ( (A list_0) (B Nat_0) (C Nat_0) (D Nat_0) (E list_0) (v_5 Nat_0) ) 
    (=>
      (and
        (add_0 B v_5 C)
        (length_0 C E)
        (and (= v_5 (Z_14 Z_13)) (= A (cons_0 D E)))
      )
      (length_0 B A)
    )
  )
...
(assert
  (forall ( (A Q_0) (B Maybe_0) (C Nat_0) (D list_0) (E list_0) ) 
    (=>
      (and
        (and (= B (Just_0 C)) (= A (Q_1 (cons_0 C D) E)))
      )
      (fstL_0 B A)
    )
  )
...
(assert
  (forall ( (A Q_0) (B Maybe_0) (C Nat_0) ) 
    (=>
      (and
        (and (= B (Just_0 C)) (= A (Q_1 nil_0 (cons_0 C nil_0))))
      )
      (fstL_0 B A)
    )
  )
  ...
  (forall ( (A list_0) (B Nat_0) (C list_0) (D Nat_0) (E list_0) (F Nat_0) (v_6 Nat_0) (v_7 Nat_0) ) 
    (=>
      (and
        ...
        (gt_0 F v_7)
        (drop_0 C B E)
        (and (= v_6 (Z_14 Z_13)) (= v_7 Z_13) (= A (cons_0 D E)))
      )
      (drop_0 C F A)
    )
  )
  ...
  (forall ( (A pair_2) (B list_0) (C list_0) (D Nat_0) (E Nat_0) (F list_0) (v_6 Nat_0) ) 
    (=>
      (and
        ...
        (drop_0 C E F)
        (length_0 D F)
        (and (= v_6 (Z_14 (Z_14 Z_13))) (= A (pair_3 B C)))
      )
      (halve_0 A F)
    )
  )
  ...
  (forall ( (A Q_0) (B Q_0) (C Q_0) (D list_0) (E list_0) (F list_0) (G list_0) (H list_0) (I list_0) (J list_0) (K list_0) ) 
    (=>
      (and
        ...
        (x_16 E J D)
        (reverse_0 F H)
        (and (= B (Q_1 J K)) (= C (Q_1 E G)) (= A (Q_1 H I)))
      )
      (x_20 C B A)
    )
  )
  ...
  (forall ( (A pair_2) (B Q_0) (C list_0) (D list_0) (E list_0) (F list_0) (v_6 list_0) ) 
    (=>
      (and
        (halve_0 A F)
        (reverse_0 C E)
        (and (= B (Q_1 C D)) (= A (pair_3 D E)) (= v_6 nil_0))
      )
      (mkQ_0 B v_6 F)
    )
  )
...
(assert
  (forall ( (A Maybe_0) (B list_0) (C Q_0) (D Maybe_0) (E Nat_0) (F list_0) (G E_0) ) 
    (=>
      (and
        (list_1 B G)
        (fstL_0 D C)
...
(assert
  (forall ( (A Q_0) (B Maybe_0) (C E_0) (v_3 list_0) (v_4 Maybe_0) ) 
    (=>
      (and
        (list_1 v_3 C)
        (fstL_0 B A)
