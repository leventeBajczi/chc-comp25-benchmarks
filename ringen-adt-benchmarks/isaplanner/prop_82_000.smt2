...
(assert
  (forall ( (A list_1) (B Nat_0) (C list_1) (D list_1) (E pair_0) (F list_1) (G Nat_0) ) 
    (=>
      (and
        (take_1 D G F)
        (and (= A (cons_1 E F)) (= C (cons_1 E D)) (= B (S_0 G)))
      )
      (take_1 C B A)
    )
  )
...
(assert
  (forall ( (A list_1) (v_1 list_1) (v_2 Nat_0) ) 
    (=>
      (and
        (and true (= v_1 nil_1) (= v_2 Z_0))
      )
      (take_1 v_1 v_2 A)
    )
  )
