...
(assert
  (forall ( (A list_0) (B list_1) (C list_1) (D Nat_0) (E list_0) (F Nat_0) (G list_0) ) 
    (=>
      (and
        (zip_0 C G E)
        (and (= B (cons_1 (pair_1 F D) C)) (= A (cons_0 D E)))
      )
      (zipConcat_0 B F G A)
    )
  )
...
(assert
  (forall ( (A Nat_0) (B list_0) (v_2 list_1) (v_3 list_0) ) 
    (=>
      (and
...
(assert
  (forall ( (A list_0) (B list_1) (C list_1) (D Nat_0) (E list_0) (F list_0) ) 
    (=>
      (and
        (diseqlist_1 B C)
        (zipConcat_0 C D E F)
