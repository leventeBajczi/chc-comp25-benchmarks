...
(assert
  (forall ( (A Form_0) (B list_2) (C list_1) (D list_2) (E Form_0) (v_5 list_1) (v_6 Bool_0) ) 
    (=>
      (and
        (models_3 B A v_5)
        (and (= v_5 nil_1) (= B (cons_2 C D)) (= A (Not_0 E)) (= v_6 false_0))
      )
      (valid_0 v_6 E)
    )
  )
...
(assert
  (forall ( (A Form_0) (B Form_0) (v_2 list_2) (v_3 list_1) (v_4 Bool_0) ) 
    (=>
      (and
        (models_3 v_2 A v_3)
        (and (= v_2 nil_2) (= v_3 nil_1) (= A (Not_0 B)) (= v_4 true_0))
      )
      (valid_0 v_4 B)
    )
  )
...
(assert
  (forall ( (A Form_0) (B Bool_0) (C Form_0) (D Form_0) (v_4 Bool_0) (v_5 Bool_0) ) 
    (=>
      (and
        (diseqBool_0 B v_4)
        (valid_0 B D)
        (valid_0 v_5 A)
        (and (= v_4 true_0) (= v_5 true_0) (= A (x_0 C D)))
      )
      false
    )
  )
