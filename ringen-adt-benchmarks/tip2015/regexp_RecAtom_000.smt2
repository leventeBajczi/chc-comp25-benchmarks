...
(assert
  (forall ( (A list_0) (B list_0) (C Bool_0) (D Bool_0) (E Bool_0) (F A_0) (G list_0) (H A_0) (I list_0) ) 
    (=>
      (and
        (and_0 C D E)
        (eqA_0 D H F)
        (eqList_0 E I G)
        (and (= B (cons_0 H I)) (= A (cons_0 F G)))
      )
      (eqList_0 C B A)
    )
  )
...
(assert
  (forall ( (A list_0) (B A_0) (C list_0) (v_3 Bool_0) (v_4 list_0) ) 
    (=>
      (and
        (and (= A (cons_0 B C)) (= v_3 false_0) (= v_4 nil_1))
      )
      (eqList_0 v_3 A v_4)
    )
  )
...
(assert
  (forall ( (v_0 Bool_0) (v_1 list_0) (v_2 list_0) ) 
    (=>
      (and
        (and true (= v_0 true_0) (= v_1 nil_1) (= v_2 nil_1))
      )
...
(assert
  (forall ( (A R_0) (B list_0) (C Bool_0) (D Bool_0) (E A_0) (F list_0) ) 
    (=>
      (and
        (diseqBool_0 C D)
        (eqList_0 D F B)
        (recognise_0 C A F)
        (and (= A (Atom_0 E)) (= B (cons_0 E nil_1)))
      )
      false
    )
  )
