  ...
  (forall ( (A list_0) (B list_0) (C Nat_0) (D list_0) (E Nat_0) (F list_0) (G Nat_0) (v_7 Nat_0) (v_8 Nat_0) ) 
    (=>
      (and
        ...
        (gt_0 G v_8)
        (take_0 D C F)
        (and (= v_7 (Z_6 Z_5)) (= v_8 Z_5) (= B (cons_0 E D)) (= A (cons_0 E F)))
      )
      (take_0 B G A)
    )
  )
...
(assert
  (forall ( (A pair_0) (B Nat_0) (C Nat_0) (D Nat_0) (E list_0) (F list_0) (G Nat_0) (H list_0) (I list_0) (J list_0) (v_10 Nat_0) (v_11 Nat_0) (v_12 Nat_0) ) 
    (=>
      (and
        (div_0 D C v_10)
        (stoogesort_1 F H)
  ...
  (and a!1 (= v_11 (Z_6 (Z_6 Z_5))) (= v_12 (Z_6 Z_5)) (= A (pair_1 H I))))
      )
      (stoogesort_0 E J)
    )
  )
