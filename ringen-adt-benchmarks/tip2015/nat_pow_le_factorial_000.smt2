...
(assert
  (forall ( (v_0 Nat_0) (v_1 Nat_0) ) 
    (=>
      (and
        (and true (= v_0 (succ_0 zero_0)) (= v_1 zero_0))
      )
      (factorial_0 v_0 v_1)
    )
  )
...
(assert
  (forall ( (A Nat_0) (B Nat_0) (C Nat_0) (D Nat_0) (E Bool_0) (F Nat_0) (v_6 Nat_0) (v_7 Bool_0) (v_8 Nat_0) (v_9 Nat_0) ) 
    (=>
      (and
        (plus_0 C v_6 F)
        (lt_0 E B D)
        ...
        (diseqBool_0 E v_7)
        (plus_0 A v_8 F)
        (formulapow_0 B v_9 A)
        (let ((a!1 (succ_0 (succ_0 (succ_0 (succ_0 zero_0))))))
  (and (= v_6 a!1) (= v_7 true_0) (= v_8 a!1) (= v_9 (succ_0 (succ_0 zero_0)))))
      )
      CHC_COMP_FALSE
    )
  )
