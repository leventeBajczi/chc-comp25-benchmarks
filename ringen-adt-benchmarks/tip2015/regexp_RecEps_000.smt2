...
(assert
  (forall ( (A list_0) (B Bool_0) (C A_0) (D list_0) (v_4 Bool_0) (v_5 R_0) ) 
    (=>
      (and
        (diseqBool_0 B v_4)
        (recognise_0 B v_5 A)
        (and (= v_4 false_0) (= v_5 Eps_0) (= A (cons_0 C D)))
      )
      CHC_COMP_FALSE
    )
  )
...
(assert
  (forall ( (A Bool_0) (v_1 Bool_0) (v_2 R_0) (v_3 list_0) ) 
    (=>
      (and
        (diseqBool_0 A v_1)
        (recognise_0 A v_2 v_3)
        (and (= v_1 true_0) (= v_2 Eps_0) (= v_3 nil_1))
      )
      CHC_COMP_FALSE
    )
  )
