...
(assert
  (forall ( (A R_0) (B R_0) (C R_0) (D R_0) ) 
    (=>
      (and
        (rev_0 C D)
        (and (= B (Star_0 C)) (= A (Star_0 D)))
      )
      (rev_0 B A)
    )
  )
...
(assert
  (forall ( (A list_0) (B list_0) (C list_0) (D A_0) (E list_0) (F list_0) ) 
    (=>
      (and
        (x_18 C E F)
...
(assert
  (forall ( (A list_0) (B list_0) (C list_0) (D list_0) (E A_0) (F list_0) ) 
    (=>
      (and
        (x_18 C D A)
        (reverse_0 D F)
        (and (= A (cons_0 E nil_1)) (= B (cons_0 E F)))
      )
      (reverse_0 C B)
    )
  )
...
(assert
  (forall ( (A R_0) (B Bool_0) (C list_0) (D Bool_0) (E R_0) (F list_0) ) 
    (=>
      (and
        (recognise_0 B A F)
        (recognise_0 D E C)
