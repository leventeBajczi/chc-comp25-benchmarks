...
(assert
  (forall ( (A R_0) (B R_0) (C R_0) (D R_0) (E R_0) (F R_0) ) 
    (=>
      (and
        (and (= B (Star_0 E)) (= C (Seq_0 (Star_0 E) (Plus_0 D F))) (= A (Plus_0 D F)))
      )
      (seq_1 C B A)
    )
  )
...
(assert
  (forall ( (A R_0) (B R_0) (C R_0) (D R_0) (E R_0) (F R_0) (G R_0) ) 
    (=>
      (and
        (and (= B (Seq_0 E F)) (= C (Seq_0 (Seq_0 E F) (Seq_0 D G))) (= A (Seq_0 D G)))
      )
      (seq_1 C B A)
    )
  )
...
(assert
  (forall ( (A R_0) (B R_0) (C R_0) (D R_0) (E R_0) (F R_0) (v_6 Bool_0) (v_7 Bool_0) ) 
    (=>
      (and
        (eps_1 v_6 E)
        (deeps_0 C E)
        (deeps_0 D F)
        (eps_1 v_7 F)
        (and (= v_6 true_0) (= v_7 true_0) (= B (Plus_0 C D)) (= A (Seq_0 E F)))
      )
      (deeps_0 B A)
    )
  )
...
(assert
  (forall ( (A R_0) (B R_0) (C Bool_0) (D R_0) (E R_0) (v_5 Bool_0) ) 
    (=>
      (and
        (eps_1 C D)
        (diseqBool_0 C v_5)
        (and (= v_5 true_0) (= B (Seq_0 D E)) (= A (Seq_0 D E)))
      )
      (deeps_0 B A)
    )
  )
...
(assert
  (forall ( (A R_0) (B R_0) (C A_0) ) 
    (=>
      (and
        (and (= B (Atom_0 C)) (= A (Atom_0 C)))
      )
      (deeps_0 B A)
    )
  )
...
(assert
  (forall ( (v_0 R_0) (v_1 R_0) ) 
    (=>
      (and
        (and true (= v_0 Nil_0) (= v_1 Eps_0))
      )
      (deeps_0 v_0 v_1)
    )
  )
...
(assert
  (forall ( (A R_0) (B R_0) (C Bool_0) (D R_0) (E Bool_0) (F R_0) (G list_0) ) 
    (=>
      (and
        (recognise_0 C B G)
        (recognise_0 E A G)
