...
(assert
  (forall ( (v_0 Nat_0) (v_1 Nat_0) ) 
    (=>
      (and
        (and true (= v_0 zero_0) (= v_1 (succ_0 zero_0)))
      )
...
(assert
  (forall ( (A Nat_0) (B Nat_0) (C Nat_0) (D Nat_0) (E Nat_0) (F Nat_0) (G Nat_0) (v_7 Nat_0) (v_8 Nat_0) (v_9 Nat_0) ) 
    (=>
      (and
        (plus_0 D v_7 F)
        (diseqNat_0 B v_8)
...
(assert
  (forall ( (v_0 Nat_0) (v_1 Nat_0) (v_2 Nat_0) (v_3 Nat_0) ) 
    (=>
      (and
        (diseqNat_0 v_0 v_1)
        (and (= v_0 zero_0) (= v_1 (succ_0 zero_0)) (= v_2 zero_0) (= v_3 zero_0))
      )
  ...
  (forall ( (A list_0) (B list_0) (C Bool_0) (D Bool_0) (E Bool_0) (F Nat_0) (G list_0) (H Nat_0) ) 
    (=>
      (and
        ...
        (leq_0 D H F)
        (ordered_0 E A)
        (and (= A (cons_0 F G)) (= B (cons_0 H (cons_0 F G))))
      )
      (ordered_0 C B)
    )
  )
