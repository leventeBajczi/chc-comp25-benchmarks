...
(assert
  (forall ( (v_0 Integer_0) ) 
    (=>
      (and
        (and true (= v_0 (P_1 zero_0)))
      )
      (zero_1 v_0)
    )
  )
...
(assert
  (forall ( (A Integer_0) (B Integer_0) (C Nat_0) (D Nat_0) (v_4 Nat_0) ) 
    (=>
      (and
        (plus_0 C v_4 D)
        (and (= v_4 (succ_0 zero_0)) (= A (N_0 D)) (= B (P_1 C)))
      )
      (neg_0 B A)
    )
  )
...
(assert
  (forall ( (A Integer_0) (B Integer_0) (C Nat_0) ) 
    (=>
      (and
        (and (= A (P_1 (succ_0 C))) (= B (N_0 C)))
      )
      (neg_0 B A)
    )
  )
...
(assert
  (forall ( (v_0 Integer_0) (v_1 Integer_0) ) 
    (=>
      (and
        (and true (= v_0 (P_1 zero_0)) (= v_1 (P_1 zero_0)))
      )
      (neg_0 v_0 v_1)
    )
  )
