...
(let ((a!2 (= (<= 1.0 N4) (= (ite (= N3 5.0) X1 a!1) 0.0)))
      ...
      (a!10 (= (<= 4.0 P4) (= (ite (= D4 5.0) H2 a!9) 0.0)))
      (a!12 (= (<= 4.0 N4) (= (ite (= T3 5.0) X1 a!11) 0.0)))
      (a!14 (= (<= 4.0 L4) (= (ite (= J3 5.0) N1 a!13) 0.0)))
      (a!16 (= (<= 4.0 J4) (= (ite (= Z2 5.0) D1 a!15) 0.0)))
      (a!18 (= (<= 4.0 H4) (= (ite (= P2 5.0) T a!17) 0.0)))
