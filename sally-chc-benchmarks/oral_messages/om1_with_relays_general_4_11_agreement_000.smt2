    ...
    (=>
      (and
        (invariant A
           ...
           E4
           F4)
        (let ((a!1 (or (and L3 (not (= Z3 A4)))
               (and M3 (not (= Z3 B4)))
               (and N3 (not (= Z3 C4)))))
      (a!2 (or (and K3 (not (= A4 Z3)))
               (and M3 (not (= A4 B4)))
               (and N3 (not (= A4 C4)))))
      (a!3 (or (and K3 (not (= B4 Z3)))
               (and L3 (not (= B4 A4)))
               (and N3 (not (= B4 C4)))))
      (a!4 (or (and K3 (not (= C4 Z3)))
               (and L3 (not (= C4 A4)))
               (and M3 (not (= C4 B4))))))
  (and (or (and K3 a!1) (and L3 a!2) (and M3 a!3) (and N3 a!4)) (<= 3.0 D4)))
      )
      false
    )
  )
