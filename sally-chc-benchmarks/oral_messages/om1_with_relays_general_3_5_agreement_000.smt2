    ...
    (=>
      (and
        (invariant A
           ...
           Q1
           R1)
        (let ((a!1 (or (and F1 (not (= M1 N1))) (and G1 (not (= M1 O1)))))
      (a!2 (or (and E1 (not (= N1 M1))) (and G1 (not (= N1 O1)))))
      (a!3 (or (and E1 (not (= O1 M1))) (and F1 (not (= O1 N1))))))
  (and (or (and E1 a!1) (and F1 a!2) (and G1 a!3)) (<= 3.0 P1)))
      )
      false
    )
  )
