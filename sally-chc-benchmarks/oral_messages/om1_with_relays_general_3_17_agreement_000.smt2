    ...
    (=>
      (and
        (invariant A
           ...
           W4
           X4)
        (let ((a!1 (or (and Z3 (not (= S4 T4))) (and A4 (not (= S4 U4)))))
      (a!2 (or (and Y3 (not (= T4 S4))) (and A4 (not (= T4 U4)))))
      (a!3 (or (and Y3 (not (= U4 S4))) (and Z3 (not (= U4 T4))))))
  (and (or (and Y3 a!1) (and Z3 a!2) (and A4 a!3)) (<= 3.0 V4)))
      )
      false
    )
  )
