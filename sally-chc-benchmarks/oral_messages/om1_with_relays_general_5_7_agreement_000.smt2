    ...
    (=>
      (and
        (invariant A
           ...
           K3
           L3)
        (let ((a!1 (or (and T2 (not (= E3 F3)))
               (and U2 (not (= E3 G3)))
               (and V2 (not (= E3 H3)))
               (and W2 (not (= E3 I3)))))
      (a!2 (or (and S2 (not (= F3 E3)))
               (and U2 (not (= F3 G3)))
               (and V2 (not (= F3 H3)))
               (and W2 (not (= F3 I3)))))
      (a!3 (or (and S2 (not (= G3 E3)))
               (and T2 (not (= G3 F3)))
               (and V2 (not (= G3 H3)))
               (and W2 (not (= G3 I3)))))
      (a!4 (or (and S2 (not (= H3 E3)))
               (and T2 (not (= H3 F3)))
               (and U2 (not (= H3 G3)))
               (and W2 (not (= H3 I3)))))
      (a!5 (or (and S2 (not (= I3 E3)))
               (and T2 (not (= I3 F3)))
               (and U2 (not (= I3 G3)))
               (and V2 (not (= I3 H3))))))
  (and (or (and S2 a!1) (and T2 a!2) (and U2 a!3) (and V2 a!4) (and W2 a!5))
       (<= 3.0 J3)))
      )
      false
    )
