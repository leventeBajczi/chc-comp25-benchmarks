    ...
    (=>
      (and
        (invariant A
           ...
           D3
           E3)
        (let ((a!1 (or (and N2 (not (= Y2 Z2)))
               (and O2 (not (= Y2 A3)))
               (and P2 (not (= Y2 B3)))))
      (a!2 (or (and M2 (not (= Z2 Y2)))
               (and O2 (not (= Z2 A3)))
               (and P2 (not (= Z2 B3)))))
      (a!3 (or (and M2 (not (= A3 Y2)))
               (and N2 (not (= A3 Z2)))
               (and P2 (not (= A3 B3)))))
      (a!4 (or (and M2 (not (= B3 Y2)))
               (and N2 (not (= B3 Z2)))
               (and O2 (not (= B3 A3))))))
  (and (or (and M2 a!1) (and N2 a!2) (and O2 a!3) (and P2 a!4)) (<= 3.0 C3)))
      )
      false
    )
  )
