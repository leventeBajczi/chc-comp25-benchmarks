    ...
    (=>
      (and
        (invariant A
           ...
           S1
           T1)
        (let ((a!1 (or (and F1 (not (= M1 N1)))
               (and G1 (not (= M1 O1)))
               (and H1 (not (= M1 P1)))
               (and I1 (not (= M1 Q1)))))
      (a!2 (or (and E1 (not (= N1 M1)))
               (and G1 (not (= N1 O1)))
               (and H1 (not (= N1 P1)))
               (and I1 (not (= N1 Q1)))))
      (a!3 (or (and E1 (not (= O1 M1)))
               (and F1 (not (= O1 N1)))
               (and H1 (not (= O1 P1)))
               (and I1 (not (= O1 Q1)))))
      (a!4 (or (and E1 (not (= P1 M1)))
               (and F1 (not (= P1 N1)))
               (and G1 (not (= P1 O1)))
               (and I1 (not (= P1 Q1)))))
      (a!5 (or (and E1 (not (= Q1 M1)))
               (and F1 (not (= Q1 N1)))
               (and G1 (not (= Q1 O1)))
               (and H1 (not (= Q1 P1))))))
  (and (or (and E1 a!1) (and F1 a!2) (and G1 a!3) (and H1 a!4) (and I1 a!5))
       (<= 3.0 R1)))
      )
      false
    )
