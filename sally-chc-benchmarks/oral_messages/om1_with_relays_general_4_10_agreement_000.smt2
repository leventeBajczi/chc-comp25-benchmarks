    ...
    (=>
      (and
        (invariant A
           ...
           V3
           W3)
        (let ((a!1 (or (and D3 (not (= Q3 R3)))
               (and E3 (not (= Q3 S3)))
               (and F3 (not (= Q3 T3)))))
      (a!2 (or (and C3 (not (= R3 Q3)))
               (and E3 (not (= R3 S3)))
               (and F3 (not (= R3 T3)))))
      (a!3 (or (and C3 (not (= S3 Q3)))
               (and D3 (not (= S3 R3)))
               (and F3 (not (= S3 T3)))))
      (a!4 (or (and C3 (not (= T3 Q3)))
               (and D3 (not (= T3 R3)))
               (and E3 (not (= T3 S3))))))
  (and (or (and C3 a!1) (and D3 a!2) (and E3 a!3) (and F3 a!4)) (<= 3.0 U3)))
      )
      false
    )
  )
