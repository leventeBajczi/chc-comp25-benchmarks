    ...
    (=>
      (and
        (invariant A
           ...
           Y5
           Z5)
        (let ((a!1 (or (and B5 (not (= S5 T5)))
               (and C5 (not (= S5 U5)))
               (and D5 (not (= S5 V5)))
               (and E5 (not (= S5 W5)))))
      (a!2 (or (and A5 (not (= T5 S5)))
               (and C5 (not (= T5 U5)))
               (and D5 (not (= T5 V5)))
               (and E5 (not (= T5 W5)))))
      (a!3 (or (and A5 (not (= U5 S5)))
               (and B5 (not (= U5 T5)))
               (and D5 (not (= U5 V5)))
               (and E5 (not (= U5 W5)))))
      (a!4 (or (and A5 (not (= V5 S5)))
               (and B5 (not (= V5 T5)))
               (and C5 (not (= V5 U5)))
               (and E5 (not (= V5 W5)))))
      (a!5 (or (and A5 (not (= W5 S5)))
               (and B5 (not (= W5 T5)))
               (and C5 (not (= W5 U5)))
               (and D5 (not (= W5 V5))))))
  (and (or (and A5 a!1) (and B5 a!2) (and C5 a!3) (and D5 a!4) (and E5 a!5))
       (<= 3.0 X5)))
      )
      false
    )
