    ...
    (=>
      (and
        (invariant A
           ...
           S2
           T2)
        (let ((a!1 (or (and D2 (not (= O2 P2))) (and E2 (not (= O2 Q2)))))
      (a!2 (or (and C2 (not (= P2 O2))) (and E2 (not (= P2 Q2)))))
      (a!3 (or (and C2 (not (= Q2 O2))) (and D2 (not (= Q2 P2))))))
  (and (or (and C2 a!1) (and D2 a!2) (and E2 a!3)) (<= 3.0 R2)))
      )
      false
    )
  )
