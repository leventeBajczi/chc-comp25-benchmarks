    ...
    (=>
      (and
        (invariant A
           ...
           O2
           P2)
        (let ((a!1 (or (and Z1 (not (= I2 J2)))
               (and A2 (not (= I2 K2)))
               (and B2 (not (= I2 L2)))
               (and C2 (not (= I2 M2)))))
      (a!2 (or (and Y1 (not (= J2 I2)))
               (and A2 (not (= J2 K2)))
               (and B2 (not (= J2 L2)))
               (and C2 (not (= J2 M2)))))
      (a!3 (or (and Y1 (not (= K2 I2)))
               (and Z1 (not (= K2 J2)))
               (and B2 (not (= K2 L2)))
               (and C2 (not (= K2 M2)))))
      (a!4 (or (and Y1 (not (= L2 I2)))
               (and Z1 (not (= L2 J2)))
               (and A2 (not (= L2 K2)))
               (and C2 (not (= L2 M2)))))
      (a!5 (or (and Y1 (not (= M2 I2)))
               (and Z1 (not (= M2 J2)))
               (and A2 (not (= M2 K2)))
               (and B2 (not (= M2 L2))))))
  (and (or (and Y1 a!1) (and Z1 a!2) (and A2 a!3) (and B2 a!4) (and C2 a!5))
       (<= 3.0 N2)))
      )
      false
    )
