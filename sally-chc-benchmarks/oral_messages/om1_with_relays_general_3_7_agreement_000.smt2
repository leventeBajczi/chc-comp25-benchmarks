    ...
    (=>
      (and
        (invariant A
           ...
           E2
           F2)
        (let ((a!1 (or (and R1 (not (= A2 B2))) (and S1 (not (= A2 C2)))))
      (a!2 (or (and Q1 (not (= B2 A2))) (and S1 (not (= B2 C2)))))
      (a!3 (or (and Q1 (not (= C2 A2))) (and R1 (not (= C2 B2))))))
  (and (or (and Q1 a!1) (and R1 a!2) (and S1 a!3)) (<= 3.0 D2)))
      )
      false
    )
  )
