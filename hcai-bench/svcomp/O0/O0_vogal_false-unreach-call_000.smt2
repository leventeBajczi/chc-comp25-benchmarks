...
(declare-fun |main@_bb7| ( Int Int (Array Int Int) Int Int (Array Int Int) Int Int ) Bool)
(declare-fun |main@_bb10| ( Int (Array Int Int) Int (Array Int Int) Int Int Int ) Bool)
(declare-fun |main@_bb6| ( Int Int (Array Int Int) Int (Array Int Int) Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Bool) (D Bool) (E (Array Int Int)) (F Int) (G Bool) (H Bool) (I Int) (J Int) (K (Array Int Int)) (L Int) (M (Array Int Int)) (N Int) ) 
    (=>
      (and
        (main@_bb A J B E L M)
        (let ((a!1 (= D (and (not (<= 10 B)) (>= B 0)))))
  (and (or (not (<= F 0)) (not H) (<= J 0))
       (or (not H) (not D) (not C))
       (or (not H) (not G) (= N I))
       (or (not H) (not G) (= I 0))
       (or (not H) (= F (+ 9 J)))
       (or (not H) (= K (store E F 0)))
       (or (not H) (not (<= J 0)))
       (or (not H) (and H C))
       (or (not G) (and G H))
       (= G true)
...
(assert
  (forall ( (A Int) (B Int) (C Bool) (D Int) (E Bool) (F Bool) (G Int) (H Int) (I Int) (J (Array Int Int)) (K Int) (L (Array Int Int)) (M Int) (N Int) ) 
    (=>
      (and
        (main@_bb4 H J K L N)
        (and (= A (+ H N))
...
(assert
  (forall ( (A Int) (B Bool) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Bool) (I Bool) (J Int) (K Int) (L Int) (M (Array Int Int)) (N Int) (O (Array Int Int)) (P Int) (Q Int) ) 
    (=>
      (and
        (main@_bb7 K D M N A O E Q)
        (let ((a!1 (= C (and (not (<= 8 A)) (>= A 0)))))
...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Int) ) 
    (=>
      (and
...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Bool) (O Bool) (P Int) (Q Int) (R Int) (S (Array Int Int)) (T Int) (U Int) (V (Array Int Int)) (W Int) (X Int) ) 
    (=>
      (and
        (main@_bb7 Q R S T J V H X)
        (let ((a!1 (= B (and (not (<= 8 J)) (>= J 0)))))
