...
(declare-fun |main@_bb5| ( Int (Array Int Int) Int Int ) Bool)
...
(assert
  ...
  (and (= v_20 false)
       (= v_21 false)
       (or (<= Q 0) (not I) (not (<= D 0)))
       (or (<= Q 0) (not I) (not (<= E 0)))
       (or (not O) J (not I))
       (or (not O) (not N) (= S P))
       (or (not O) (not N) (= P M))
       (or (not I) (= H (<= F G)))
...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D Int) (E Bool) (F Bool) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Int) (L (Array Int Int)) (M Int) (N (Array Int Int)) (O Bool) (P Bool) (Q Int) (R Int) (S (Array Int Int)) (T Int) (U Int) (V Int) (W Int) ) 
    (=>
      (and
        (main@_bb2 R I H U V W)
        (let ((a!1 (or (not E) (not (= (<= D U) F))))
      (a!2 (or (not E) (= C (+ R (* 4 M)))))
      (a!3 (or (not P) (= G (+ R (* 4 M)))))
      (a!4 (or (not P) (= J (+ R (* 4 H))))))
  (and (= M (+ (- 1) H))
       (or (<= R 0) (not E) (not (<= C 0)))
       (or (not E) B (not A))
       (or (not P) (<= R 0) (not (<= G 0)))
       (or (not P) (<= R 0) (not (<= J 0)))
       (or (not P) (not E) F)
       (or (not P) (not O) (= N L))
       (or (not P) (not O) (= S N))
       (or (not P) (not O) (= Q M))
       (or (not P) (not O) (= T Q))
       a!1
       (or (not E) (= D (select I C)))
       a!2
       (or (not E) (not (<= R 0)))
       (or (not E) (and E A))
       (or (not O) (and P O))
       (or (not P) (= L (store I J K)))
       (or (not P) (= K (select I G)))
       a!3
       a!4
       (or (not P) (not (<= R 0)))
       (or (not P) (and P E))
