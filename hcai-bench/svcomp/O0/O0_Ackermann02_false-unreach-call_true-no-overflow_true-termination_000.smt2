...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Bool) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (v_14 Bool) (v_15 Bool) ) 
    (=>
      (and
        main@entry
        (ackermann K v_14 v_15 F E G)
        (let ((a!1 (= C (or (not (<= E 23)) (not (>= E 0)))))
      (a!2 (or (not K) (not (= (<= 2 F) H))))
      (a!3 (or (not K) (not (= (<= G 3) I))))
      (a!4 (= A (or (not (<= F 3)) (not (>= F 0))))))
  (and (= v_14 false)
       (= v_15 false)
       (or (not D) a!1)
       (or (not D) (and D B))
