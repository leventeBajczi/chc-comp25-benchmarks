...
(assert
  ...
  (and (not (= (<= Q R) S))
       ...
       (or (not B1) (not G1) (not D1))
       (or (not V) (not W) (not D1))
       (or (not (<= C 0)) (<= A 0))
       (or (not (<= F 0)) (<= D 0))
       (or (not (<= H 0)) (<= J 0))
       (or (not (<= K 0)) (<= J 0))
