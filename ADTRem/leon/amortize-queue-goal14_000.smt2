...
(assert
  (forall ( (A queueOfInt) (B listOfInt) (C queueOfInt) (D Bool) (E listOfInt) (F listOfInt) (G listOfInt) (H Int) (I listOfInt) (J queueOfInt) (K listOfInt) ) 
    (=>
      (and
        (adt_new1 I K D)
        (queuetolst C G)
        ...
        (enqueue A H J)
        (queuetolst J K)
        (and (= C (queuequeueOfInt E F))
     (= B (conslistOfInt H nillistOfInt))
     (not D)
     (= A (queuequeueOfInt E F)))
      )
      ff
    )
  )
