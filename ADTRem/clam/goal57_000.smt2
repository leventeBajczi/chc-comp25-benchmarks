...
(assert
  (forall ( (A listOfInt) (B listOfInt) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J listOfInt) (K listOfInt) (L listOfInt) (M listOfInt) (N listOfInt) (O listOfInt) (P listOfInt) ) 
    (=>
      (and
        (adt_new1 M P C)
        (drop D B K)
        ...
        (drop G N O)
        (drop F O P)
        (and (= B (conslistOfInt H (conslistOfInt I J)))
     (= D (+ 1 E))
     (>= G 0)
     (>= F 1)
     (>= E 0)
