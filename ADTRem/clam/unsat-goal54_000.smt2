...
(assert
  (forall ( (A listOfInt) (B Bool) (C Int) (D Int) (E Int) (F Int) (G listOfInt) (H listOfInt) (I listOfInt) (J listOfInt) (K listOfInt) ) 
    (=>
      (and
        (adt_new1 I K B)
        (drop E A H)
        ...
        (drop E G J)
        (drop D J K)
        (and (= C (+ 1 D)) (>= E 0) (>= D 0) (= B true) (= A (conslistOfInt F G)))
      )
      ff
    )
  )
