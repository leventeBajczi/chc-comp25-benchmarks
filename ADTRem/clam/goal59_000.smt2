...
(assert
  (forall ( (A listOfInt) (B listOfInt) (C Bool) (D listOfInt) (E Int) (F listOfInt) (G listOfInt) (H listOfInt) (I listOfInt) (J listOfInt) (K listOfInt) ) 
    (=>
      (and
        (adt_new1 I B C)
        (append D A F)
        ...
        (append G D J)
        (rev J K)
        (and (= B (conslistOfInt E K)) (not C) (= A (conslistOfInt E nillistOfInt)))
      )
      ff
    )
  )
