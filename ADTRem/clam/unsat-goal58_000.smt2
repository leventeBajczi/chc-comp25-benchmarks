...
(assert
  (forall ( (A listOfInt) (B listOfInt) (C Bool) (D listOfInt) (E Int) (F listOfInt) (G listOfInt) (H listOfInt) ) 
    (=>
      (and
        (adt_new1 G B C)
        (append D A F)
        (rev F G)
        (rev D H)
        (and (= B (conslistOfInt E H)) (= C true) (= A (conslistOfInt E nillistOfInt)))
      )
      ff
    )
  )
