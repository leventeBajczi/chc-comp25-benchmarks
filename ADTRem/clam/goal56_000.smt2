...
(assert
  (forall ( (A listOfInt) (B Bool) (C Int) (D Int) (E Int) (F Int) (G Int) (H listOfInt) (I listOfInt) (J listOfInt) (K listOfInt) (L listOfInt) (M listOfInt) (N listOfInt) ) 
    (=>
      (and
        (adt_new1 K N B)
        (drop F A I)
        ...
        (drop E L M)
        (drop D M N)
        (and (= C (+ 1 D)) (>= F 0) (>= E 0) (>= D 0) (not B) (= A (conslistOfInt G H)))
      )
      ff
    )
  )
