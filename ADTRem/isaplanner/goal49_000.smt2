...
(assert
  (forall ( (A listOfInt) (B listOfInt) (C listOfInt) (D Int) (E Int) (F listOfInt) (G listOfInt) ) 
    (=>
      (and
        (butlast A G)
        (and (= C (conslistOfInt D (conslistOfInt E F)))
     (= A (conslistOfInt E F))
     (= B (conslistOfInt D G)))
      )
      (butlast C B)
...
(assert
  (forall ( (A Bool) (B listOfInt) (C listOfInt) (D listOfInt) (E listOfInt) (v_5 listOfInt) ) 
    (=>
      (and
        (adt_new1 D E A)
        (append B v_5 C)
...
(assert
  (forall ( (A listOfInt) (B listOfInt) (C Bool) (D listOfInt) (E Int) (F listOfInt) (G listOfInt) (H listOfInt) (I listOfInt) (J listOfInt) ) 
    (=>
      (and
        (adt_new1 H J C)
        (append D B G)
        ...
        (butlast A I)
        (append D I J)
        (and (= B (conslistOfInt E F)) (not C) (= A (conslistOfInt E F)))
      )
      ff
    )
  )
