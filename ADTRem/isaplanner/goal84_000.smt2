...
(assert
  (forall ( (A listOfInt) (B listOfInt) (C Int) (D Int) (E listOfInt) (F listOfInt) (G Int) ) 
    (=>
      (and
        (take G E F)
        (and (= A (conslistOfInt D F)) (= C (+ 1 G)) (>= G 0) (= B (conslistOfInt D E)))
      )
      (take C B A)
    )
  )
...
(assert
  (forall ( (A Int) (B listOfpairOfIntInt) (v_2 listOfpairOfIntInt) ) 
    (=>
      (and
        (and (= A 0) (= v_2 nil-listOfpairOfIntInt))
      )
      (ztake A B v_2)
    )
  )
...
(assert
  (forall ( (A listOfpairOfIntInt) (B listOfpairOfIntInt) (C Int) (D pairOfIntInt) (E listOfpairOfIntInt) (F listOfpairOfIntInt) (G Int) ) 
    (=>
      (and
        (ztake G E F)
        (and (= B (cons-listOfpairOfIntInt D E))
     (= C (+ 1 G))
     (>= G 0)
     (= A (cons-listOfpairOfIntInt D F)))
      )
      (ztake C B A)
    )
  )
