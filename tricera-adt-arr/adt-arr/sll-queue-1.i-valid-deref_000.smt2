...
(declare-fun |inv_main1018_12| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main1004_3| ( Heap Int Int Int Int ) Bool)
...
(declare-fun |inv_main_62| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main_38| ( Heap Int Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Heap) (D Int) (E Int) (F Int) (G Int) (H Int) (I Heap) ) 
    (=>
      (and
        (inv_main1018_12 I H G F)
        (let ((a!1 (ite (and (not (<= G 0)) (>= (HeapSize I) G))
                (select (HeapContents I) G)
                defObj)))
(let ((a!2 (O_TSLL (TSLL (|TSLL::next| (getTSLL a!1)) 3))))
(let ((a!3 (ite (and (not (<= G 0)) (>= (HeapSize I) G))
                (HeapCtor (HeapSize I) (store (HeapContents I) G a!2))
                I)))
  (and (not (= D 0))
