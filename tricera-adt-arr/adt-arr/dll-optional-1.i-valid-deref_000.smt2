...
(declare-fun |inv_main1000_199| ( Heap Int ) Bool)
(declare-fun |inv_main_29| ( Heap Int Int ) Bool)
(declare-fun |inv_main1009_15| ( Heap Int Int Int ) Bool)
(declare-fun |inv_main1003_36| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main1003_173| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main1000_156| ( Heap Int ) Bool)
...
(declare-fun |inv_main1000_31| ( Heap Int ) Bool)
(declare-fun |inv_main1000_49| ( Heap Int Int ) Bool)
(declare-fun |inv_main1003_308| ( Heap Int Int ) Bool)
(declare-fun |inv_main_5| ( Heap Int ) Bool)
(declare-fun |inv_main_15| ( Heap Int Int ) Bool)
(declare-fun |inv_main_21| ( Heap Int Int ) Bool)
(declare-fun |inv_main1003_158| ( Heap Int Int ) Bool)
(declare-fun |inv_main1003_274| ( Heap Int Int ) Bool)
(declare-fun |inv_main1019_7_32| ( Heap Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Heap) ) 
    (=>
      (and
        (inv_main1009_15 E D C B)
        (and (not (= B 2)) (= A 0))
      )
      (inv_main1009_15_22 E D C A)
    )
  )
)
(assert
...
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize H) F))
                ...
                H)))
  (and (= B G) (= A F) (= D 0) (not (= E 0)) (= C a!3) ((_ is O_TSLL) a!1)))))
      )
      (inv_main1003_274 C B A)
    )
  )
)
(assert
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize F) E))
                ...
                F)))
  (and (= A E) (= C 0) (= D 0) (= B a!3) ((_ is O_TSLL) a!1)))))
      )
      (inv_main1000_199 B A)
    )
  )
)
(assert
...
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize H) F))
                (HeapCtor (HeapSize H) (store (HeapContents H) F a!2))
                H)))
  (and (= B G) (= A F) (= D 0) (= E 0) (= C a!3) ((_ is O_TSLL) a!1)))))
      )
      (inv_main1003_308 C B A)
    )
  )
)
(assert
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize F) E))
                (HeapCtor (HeapSize F) (store (HeapContents F) E a!2))
                F)))
  (and (= A E) (= C 0) (not (= D 0)) (= B a!3) ((_ is O_TSLL) a!1)))))
      )
      (inv_main1000_156 B A)
    )
  )
)
(assert
