...
(declare-fun |inv_main_54| ( Heap Int Int ) Bool)
(declare-fun |inv_main_24| ( Heap Int Int ) Bool)
(declare-fun |inv_main1004_137| ( Heap Int Int ) Bool)
...
(declare-fun |inv_main_61| ( Heap Int Int ) Bool)
(declare-fun |inv_main1012_3| ( Heap Int Int Int ) Bool)
(declare-fun |inv_main1016_136| ( Heap Int Int Int ) Bool)
(declare-fun |inv_main_56| ( Heap Int Int ) Bool)
(declare-fun |inv_main1004_100| ( Heap Int ) Bool)
(declare-fun |inv_main1016_254| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main1002_2_1| ( Heap Int ) Bool)
(declare-fun |inv_main_25| ( Heap Int Int ) Bool)
(declare-fun |inv_main1016_100| ( Heap Int Int ) Bool)
(declare-fun |inv_main1027_3| ( Heap Int Int Int ) Bool)
(declare-fun |inv_main1004_258| ( Heap Int Int ) Bool)
...
(assert
  (forall ( (A Heap) (B Int) (C Int) (D Int) (E Heap) ) 
    (=>
      (and
        (inv_main1012_3 E D C B)
        (let ((a!1 (ite (and (not (<= C 0)) (>= (HeapSize E) C))
                (select (HeapContents E) C)
                defObj)))
(let ((a!2 (O_TSLL (TSLL B (|TSLL::inner| (getTSLL a!1))))))
...
(let ((a!4 (ite a!3
                ...
                defObj)))
(let ((a!5 (O_TSLL (TSLL 0 (|TSLL::inner| (getTSLL a!4))))))
...
(let ((a!4 (ite a!3
                (select (HeapContents D) (|TSLL::inner| (getTSLL a!1)))
                defObj)))
(let ((a!5 (O_TSLL (TSLL (|TSLL::next| (getTSLL a!4)) 0))))
(let ((a!6 (HeapCtor (HeapSize D)
                     (store (HeapContents D) (|TSLL::inner| (getTSLL a!1)) a!5))))
  (and ((_ is O_TSLL) a!1) (= A (ite a!3 a!6 D)) ((_ is O_TSLL) a!4))))))))
      )
...
(assert
  (forall ( (A Int) (B Int) (C Heap) (D Int) (E Int) (F Int) (G Int) (H Heap) (v_8 Int) ) 
    (=>
      (and
        (inv_main1006_2 H G F)
        (and (= A 0) (= D 0) (= B 0) (= E G) (= C H) (not (= 0 E)) (= v_8 E))
      )
      (inv_main1027_3 C E v_8 A)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B TSLL) (C Heap) (D Heap) (E Int) (F Int) (G Int) (H Heap) ) 
    (=>
      (and
        (inv_main1002_2_1 H G)
        (let ((a!1 (HeapCtor (+ 1 (HeapSize D))
                     (store (HeapContents D) (+ 1 (HeapSize D)) (O_TSLL B))))
      (a!2 (ite (and (not (<= G 0)) (>= (HeapSize H) G))
                (select (HeapContents H) G)
                defObj)))
(let ((a!3 (O_TSLL (TSLL 0 (|TSLL::inner| (getTSLL a!2))))))
