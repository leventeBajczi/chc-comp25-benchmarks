...
(declare-fun |inv_main1032_3| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main1074_3| ( Heap Int Int Int ) Bool)
(declare-fun |CHC_COMP_FALSE| ( ) Bool)
(declare-fun |inv_main_19| ( Heap Int Int Int ) Bool)
(declare-fun |inv_main| ( Heap Int ) Bool)
(declare-fun |inv_main1053_7| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main1011_2| ( Heap Int Int ) Bool)
...
(declare-fun |inv_main1034_4| ( Heap Int Int Int Int ) Bool)
