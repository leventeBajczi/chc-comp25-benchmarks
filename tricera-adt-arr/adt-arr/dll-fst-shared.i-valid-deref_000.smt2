    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= B 0)) (>= (HeapSize C) B))
                ...
                defObj)))
(let ((a!2 (O_dll (dll 0 (|dll::prev| (getdll a!1)) (|dll::data| (getdll a!1))))))
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= G 0)) (>= (HeapSize I) G))
                ...
                defObj)))
(let ((a!2 (O_dll (dll (|dll::next| (getdll a!1)) (|dll::prev| (getdll a!1)) F))))
  ...
  (forall ( (A Int) (B dll) (C Heap) (D Int) (E Int) (F Int) (G Heap) (H Int) (I Int) (J Int) (K Int) (L Heap) ) 
    (=>
      ...
      (a!2 (ite (and (not (<= J 0)) (>= (HeapSize L) J))
                ...
                defObj)))
(let ((a!3 (O_dll (dll (|dll::next| (getdll a!2)) (|dll::prev| (getdll a!2)) I))))
...
(let ((a!5 (O_dll (dll (|dll::next| (getdll a!4)) (|dll::prev| (getdll a!4)) B))))
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= D 0)) (>= (HeapSize F) D))
                ...
                defObj)))
(let ((a!2 (O_dll (dll B (|dll::prev| (getdll a!1)) (|dll::data| (getdll a!1))))))
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= F 0)) (>= (HeapSize J) F))
                ...
                defObj)))
(let ((a!2 (O_dll (dll (|dll::next| (getdll a!1)) 0 (|dll::data| (getdll a!1))))))
...
(let ((a!3 (and a!2 (>= (HeapSize E) (|dll::next| (getdll a!1))))))
(let ((a!4 (ite a!3 (select (HeapContents E) (|dll::next| (getdll a!1))) defObj)))
(let ((a!5 (O_dll (dll (|dll::next| (getdll a!4)) C (|dll::data| (getdll a!4))))))
(let ((a!6 (HeapCtor (HeapSize E)
                     (store (HeapContents E) (|dll::next| (getdll a!1)) a!5))))
  (and ((_ is O_dll) a!1) (= A (ite a!3 a!6 E)) ((_ is O_dll) a!4))))))))
      )
