...
(declare-fun |inv_main1039_8| ( Heap Int Int Int Int ) Bool)
  ...
  (forall ( (A Int) (B Int) (C Heap) (D Int) (E Int) (F Int) (G Int) (H Heap) (v_8 Int) ) 
    (=>
      (and
        ...
        (and (= A 0) (= E G) (= D 0) (= B 0) (= C H) (not (= 0 E)) (= v_8 E))
      )
