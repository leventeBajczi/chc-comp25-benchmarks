...
(declare-fun |inv_main620_3| ( Heap Int Int Int ) Bool)
...
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize J) F))
                ...
                J)))
  (and (= C H) (= B G) (= A F) (= D I) (= E a!3) ((_ is O_node) a!1) (= v_10 A)))))
      )
      (inv_main620_3 E D A v_10)
    )
  )
)
(assert
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize H) E))
                ...
                H)))
  (and (= A E) (= C G) (= B F) (= D a!3) ((_ is O_node) a!1) (= v_8 A)))))
      )
